...
public class ReportChart implements ChartPostProcessor, Parameterized, DatasetProducer, Serializable, CategoryItemLinkGenerator, CategoryToolTipGenerator {    
	private final String[] categories = {""};    
	private final String[] seriesNames = {Application.getInstance().getMessage("sfa.label.totalSales","Total Sales"), Application.getInstance().getMessage("sfa.label.projection","Projection")};
