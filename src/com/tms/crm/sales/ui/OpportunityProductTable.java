 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class OpportunityProductTable extends Table {
...
*/
			tc_ProductID.setUrlParam("productSeq");
			...
			addAction(new TableAction("delete", Application.getInstance().getMessage("sfa.label.delete","Delete"),Application.getInstance().getMessage("sfa.message.deleteMessage")));
		}
