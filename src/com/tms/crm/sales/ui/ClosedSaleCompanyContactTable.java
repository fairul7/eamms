 ...
 */
public class ClosedSaleCompanyContactTable extends SalesTable{
    ...
    public class ContactTableModel extends TableModel {
        ...
        public Collection getTableRows() {
         ...
         //   String oppID = (filterOpportunityContacts) ? opportunityID : null;
            return module.listClosedSaleContacts(keyword, companyID, opportunityID, getSort(), isDesc(), getStart(), getRows());
        }
        ...
        public Collection getAllTableRows() {
            ...
            String keyword = (String) getFilterValue("keyword");
//            String oppID = (filterOpportunityContacts) ? opportunityID : null;
            return module.listClosedSaleContacts(keyword, companyID, opportunityID, getSort(), isDesc(), getStart(), -1);
        }
        ...
        public int getTotalRowCount() {
            ...
            String keyword = (String) getFilterValue("keyword");
//            String oppID = (filterOpportunityContacts) ? opportunityID : null;
            return module.countClosedSaleContacts(keyword, companyID, opportunityID);
        }
