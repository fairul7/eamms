 ...
 * Description: Table of Library listing
 * Company: TMS Berhad
 */
...
public class LibraryListingTable extends Table {
    private Log log = Log.getLog(getClass());
    
    public void init() {
        setWidth("100%");
        setModel(new LibraryListingTableModel());
    }
    ...
    public class LibraryListingTableModel extends TableModel {
        ...
        public Collection getTableRows() {
            ...
            return module.findLibrary(name, true, getSort(), isDesc(), getStart(), getRows());
        }
        ...
        public int getTotalRowCount() {
            ...
            Application application = Application.getInstance();
            LibraryModule module = (LibraryModule) application.getModule(LibraryModule.class);
            return module.countLibrary(name, true);
        }
