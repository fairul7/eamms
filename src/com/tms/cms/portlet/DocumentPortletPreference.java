...
public class DocumentPortletPreference extends ContentPortletPreference
{
    public static final String DEFAULT_TEMPLATE = "cms/portlet/documentPortletPreference";

    public DocumentPortletPreference() {
    }

    public DocumentPortletPreference(String name) {
        super(name);
    }
