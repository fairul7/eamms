...
public class DisplayLatestContent extends LightWeightWidget {
    ...
    public void onRequest(Event evt) {
        ...
        try {
            ...
            this.children = cp.viewList(null, include, null, key, Boolean.FALSE, "date", true, startIndex, pageSizeInt, permission, user.getId());
