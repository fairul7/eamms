 ...
 * Time: 10:53:42 AM
 */
public class SingleUserSelectBox extends PopupSelectBox {
    public SingleUserSelectBox() {
        super();
        super.setMultiple(false);
    }

    public SingleUserSelectBox(String name) {
        super(name);
        super.setMultiple(false);
    }
    ...
    public String getDefaultTemplate() {
        return "orgchart/popupSingleSelect";
    }
