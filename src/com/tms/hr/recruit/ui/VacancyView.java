...
public class VacancyView extends Form{
	...
	public void populateData(){
		if(getVacancyCode()!=null){
			...
			//lblRecRespon.setText("<a href=javascript:window.open('vacancyPopUp.jsp?vacancyCode="+ getVacancyCode() +"','blank','toolbar=no,width=250,height=250'); return false; >View Job Responsibilities</a>");
			...
			/*
			lblRecRespon.setText("<a href='#' onClick=javascript:window.open('vacancyPopUp.jsp?type=1','blank','toolbar=no,width=500,height=500,scrollbars=yes'); return false; >View Job Responsibilities</a>");
			lblRecRequire.setText("<a href='#' onClick=javascript:window.open('vacancyPopUp.jsp?type=2','blank','toolbar=no,width=500,height=500,scrollbars=yes'); return false; >View Job Requirements</a>"); 
			 */
