 ...
 */
public class MCalendarEventView extends CalendarEventView {
    ...
    public MCalendarEventView(String s)
    {
        super(s);
    }
    ...
    public void setEventId(String eventId)
    {
        ...
        try
        {
            ...
            if(state == VIEW) {
                ...
                //if (className.equals(Task.class.getName()) && mobile) {
                if (className.equals(Task.class.getName())) {
                    child.setTemplate("taskmanager/mtaskeventview");
                }
                //else if (className.equals(Meeting.class.getName()) && mobile) {
                else if (className.equals(Meeting.class.getName())) {
                    child.setTemplate("emeeting/mmeetingView");
                }
