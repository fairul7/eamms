 ...
 */
public class TaskEventView extends Widget implements CalendaringPermission
{
    ...
    public static final String FORWARD_START_TASK="startTask";
    public static final String FORWARD_TASK_COMPLETION="taskCompletion";

    public TaskEventView()
    {
    }

    public TaskEventView(String name)
    {
        super(name);
    }
    ...
    public void onRequest(Event evt)
    {
        ...
        if(taskId!=null && taskId.trim().length()>0){
            ...
            try
            {
                ...
                task.setComments(tm.getComments(taskId));
...
//                    }
                    ...
                    return new Forward(FORWARD_START_TASK);
                }
            }
...
//                    TaskMailer.sentTaskCompletedNotification(task,evt,userId);
                    evt.getRequest().setAttribute("taskId",taskId);
                    return new Forward(FORWARD_TASK_COMPLETION);
                }
