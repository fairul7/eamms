...
public class TimeSheetNonTaskView extends Panel {
    ...
    public String getDefaultTemplate() {
        return "timesheet/tsnontaskview";
    }
    ...
    public void loadTask() {
        ...
        if (taskId!=null && !taskId.equals("")) {
            ...
            try {
                ...
                category = tm.getCategoryByTask(taskId);
            }
            catch(Exception e) {                
            }
