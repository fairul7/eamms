...
public class DirectoryContactMessagingTable extends Table implements AddressBookWidget {
    ...
    public DirectoryContactMessagingTable() {
    }

    public DirectoryContactMessagingTable(String name) {
        super(name);
    }
