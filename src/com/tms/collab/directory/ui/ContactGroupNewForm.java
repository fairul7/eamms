...
public class ContactGroupNewForm extends Form implements AddressBookWidget {
    ...
    protected ContactSelectBox contactSelectBox;
    ...
    public String getDefaultTemplate() {
    	return "addressbook/abNewContactGroup";
    }
    
    
    
    public ContactGroupNewForm() {
    }

    public ContactGroupNewForm(String name) {
        super(name);
    }
    ...
    protected void initForm() {
        ...
        contactSelectBox = new ContactSelectBox("contactSelectBox");
        contactSelectBox.setWidgetManager(getWidgetManager());
            ...
            public boolean validate(FormField formField) {
                ...
                if (value == null || value.toString().trim().length() == 0) {
                    ...
                    try {
                        ...
                        Contact cg = mod.getContactGroupByName(value.toString(), userId, null);
                        valid = (cg == null);
                    }
