...
public class ContactTable extends Table implements AddressBookWidget {
    ...
    public static final String FORWARD_NEW_CONTACT_GROUP = "newContactGroup";
    ...
    public class ContactTableModel extends TableModel {
        ...
        public ContactTableModel() {
            ...
            addAction(new TableAction("newContactGroup", Application.getInstance().getMessage("addressbook.label.newContactGroup","New Contact Group")));
            addAction(new TableAction("move", Application.getInstance().getMessage("addressbook.label.move","Move"), Application.getInstance().getMessage("addressbook.label.moveSelectedContacts","Move selected contact(s)?")));
        ...
        public Collection getTableRows() {
            try {
                ...
                Collection rows = dm.getContactList(query, folderId, null, ownerId, null, getSort(), isDesc(), getStart(), getRows());
                return rows;
            }
        ...
        public int getTotalRowCount() {
            try {
                ...
                // invoke module
                AddressBookModule dm = getModule();
                int count = dm.getContactCount(query, folderId, null, ownerId, null);
                return count;
            }
            catch (AddressBookException e) {
        ...
        public Forward processAction(Event event, String action, String[] selectedKeys) {
            try {
                ...
                if ("newContact".equals(action)) {
                ...
                else if ("newContactGroup".equals(action)) {
                    return new Forward(FORWARD_NEW_CONTACT_GROUP);
                }
                    ...
                    event.getRequest().getSession().setAttribute(MessagingModule.TO_ATTRIBUTE, addresses);
