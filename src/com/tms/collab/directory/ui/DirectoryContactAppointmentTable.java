...
public class DirectoryContactAppointmentTable extends Table implements AddressBookWidget {
    ...
    public DirectoryContactAppointmentTable() {
    }

    public DirectoryContactAppointmentTable(String name) {
        super(name);
    }
