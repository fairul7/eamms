...
public class CancelledRequestFCTable extends Table {
	
	protected SelectBox sbRequestType;
	protected SelectBox sbStatus;

	public CancelledRequestFCTable() {
	}

	public CancelledRequestFCTable(String s) {
		super(s);
	}
	...
	public void init() {
		super.init();
		setPageSize(20);
		setModel(new CancelledRequestFCTableModel());
		setWidth("100%");
	}
	...
	class CancelledRequestFCTableModel extends TableModel {
		CancelledRequestFCTableModel() {
			removeChildren();
