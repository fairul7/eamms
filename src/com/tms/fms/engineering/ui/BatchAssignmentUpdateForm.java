 ...
 *
 */
public class BatchAssignmentUpdateForm extends Form {
	...
	public Forward onValidate(Event event) {
		try {
			...
			requestId 	= (String) tfRequestId.getValue();
			...
			if(stDate.after(edDate)){
				...
				if (diff >= 7) {
					vmsg_dtEnd.showError("Date Range more than 7 days");
					this.setInvalid(true);
					return new Forward("FAILED");
				}
			}
			...
			String fwd = "batchAssignmentUpdateList.jsp?requestId=" + requestId + "&startDate=" + startDate + "&endDate="+endDate;
	...
	public String getDefaultTemplate(){
		return "fms/engineering/batchassignmentupdatetemp";
	}
