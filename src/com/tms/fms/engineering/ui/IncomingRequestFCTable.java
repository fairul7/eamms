...
public class IncomingRequestFCTable extends Table {
	...
	public IncomingRequestFCTable() {
	}

	public IncomingRequestFCTable(String s) {
		super(s);
	}

	public void onRequest(Event event) {
		setModel(new IncomingRequestFCTableModel());
	...
	class IncomingRequestFCTableModel extends TableModel {
		IncomingRequestFCTableModel() {
			removeChildren();
...
//			title.setUrl("requestDetails.jsp");
//			title.setUrlParam("requestId");
		...
		public Collection getTableRows() {
			...
			try {
				return mod.getRequestList(requiredDateTo, searchBy, requiredDate, getDepartment(), getSort(), isDesc(), getStart(), getRows());
		...
		public int getTotalRowCount() {
			...
			return mod.selectRequestCountList(requiredDateTo, searchBy, requiredDate, getDepartment());
		}
