...
public class PrintAssignmentByRequestId extends Form {
	...
	public PrintAssignmentByRequestId() {
	}

	public PrintAssignmentByRequestId(String s) {super(s);}
	...
	public String getDefaultTemplate() {
		return "fms/facility/printAssignmentCheckOut";
	}
