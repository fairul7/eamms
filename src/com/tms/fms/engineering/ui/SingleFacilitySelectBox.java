...
public class SingleFacilitySelectBox extends PopupSelectBox {
	private String link;
	...
	public SingleFacilitySelectBox() {
	}

	public SingleFacilitySelectBox(String name) {
		super(name);
	}
	...
	public static String getName(String id) {
		...
		try {
			...
			Log.getLog(SingleFacilitySelectBox.class).error(e.toString(), e);
		}
		return null;
	}
	...
	public String getSelectedText() {
		...
		if (id != null) {
			return (String) getOptionMap().get(id);
		}
		return null;
	}
	...
	public class SingleFacilityPopupTable extends PopupSelectBoxTable {
		...
		public class SingleFacilityPopupTableModel extends PopupSelectBoxTableModel {
			...
			public Collection getTableRows() {
                ...
                try {
                	list=dao.selectRateCardFacility(keyword,serviceId, getSort(), isDesc(), getStart(), getRows());
                }
                catch (Exception e) {
