...
public class FacilityPopupSelectBox extends PopupSelectBox{

	public FacilityPopupSelectBox(){}
	
	public FacilityPopupSelectBox(String s){
		super(s);
	}
	...
	protected Table initPopupTable() {
		return new FacilityPopupSelectBoxTable();
	}

	class FacilityPopupSelectBoxTable extends PopupSelectBoxTable{
		
		public FacilityPopupSelectBoxTable(){}
		
		public FacilityPopupSelectBoxTable(String s){
			super(s);
		}
		...
		public void init() {
	        super.init();
	        setWidth("100%");
	        setModel(new FacilityPopupSelectBoxTableModel());
        }
		...
		class FacilityPopupSelectBoxTableModel extends PopupSelectBoxTableModel{
			
			public FacilityPopupSelectBoxTableModel(){
				super();
			...
			public Collection getTableRows() {
				...
				try {
			    	return dao.selectFacilityForCheckAvailability(getSearchText(), getCategory(), getChannel(), "", getSort(), isDesc(), getStart(), getRows());
