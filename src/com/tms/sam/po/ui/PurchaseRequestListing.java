...
public class PurchaseRequestListing extends Table{
	public void init(){
		setWidth("100%");
		setModel(new PurchaseRequestListingModel());
	}
	
	public class PurchaseRequestListingModel extends TableModel{
		public PurchaseRequestListingModel(){
		...
		public Collection getTableRows() {
			...
			return module.getListingItem(name, searchColValue, getSort(), isDesc(), getStart(), getRows());
		}
		...
		public int getTotalRowCount() {
            ...
            return module.countListingRequest(name, searchColValue);
		}
