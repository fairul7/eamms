...
public class UserRequestListing extends Table{
	public void init(){
		setWidth("100%");
		setModel(new UserRequestListingModel());
	}
	
	public class UserRequestListingModel extends TableModel{
		public UserRequestListingModel(){
		...
		public Collection getTableRows() {
			...
			return module.getHODListing(name, searchColValue, getSort(), isDesc(), getStart(), getRows());
		}
