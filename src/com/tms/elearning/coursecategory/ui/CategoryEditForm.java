 ...
 */
public class CategoryEditForm extends Form implements Serializable{
    ...
    public String getDefaultTemplate() {
     ...
     public void init() {
         ...
         ValidatorNotEmpty v_category = new ValidatorNotEmpty("v_category", "category required");
    ...
    public void onRequest(Event evt){
        ...
        //retrieve existing label
               try {
                  Category categoryEntry = categorymodule.loadCategory(getId());

                  category.setValue(categoryEntry.getCategory());

               } catch (DataObjectNotFoundException e) {
                   Log.getLog(getClass()).error("Error loading cel_content_course_category");
                      }
    ...
    public Forward onValidate(Event evt) {
           ...
           categorymodule.editCategory(cat);
