...
public class DocArtisPopupSelectBox extends PopupSelectBox
{
    public DocArtisPopupSelectBox()
	{
        super();
		setSortable(false);
    }

    public DocArtisPopupSelectBox(String name)
	{
        super(name);
		setSortable(false);
    }
    ...
    protected Map generateOptionMap(String[] ids)
	{
        ...
        try
		{
            ...
            Collection list = cm.viewListWithContents(ids, new String[] {Document.class.getName(),Article.class.getName()},null, null, null,
				null, null, null, null, Boolean.FALSE, null, null, false, 0, -1, ContentManager.USE_CASE_VIEW, user);
    ...
    public class ContentListTableModel extends PopupSelectBoxTableModel
	{
        ...
        public Collection getTableRows()
		{
            try
			{
				...
				classArray = new String[] {Document.class.getName(),Article.class.getName()};
