...
public class PopUpUserSelectBx extends UsersSelectBox {

    private boolean showUsername;
    private String userId;
    
    public PopUpUserSelectBx() {
        super();
    }

    public PopUpUserSelectBx(String name) {
        super(name);
    }
        ...
        public class UserTableModel extends PopupSelectBoxTableModel {
            ...
            public Collection getTableRows() {
                ...
                try {
                    ...
                    boolean leaveManager = true; 
                    	//service.hasPermission(userId, LeaveModule.PERMISSION_MANAGE_LEAVE, null, null);
                    if (leaveManager) { 
