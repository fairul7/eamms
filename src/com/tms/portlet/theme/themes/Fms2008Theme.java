...
public class Fms2008Theme extends DefaultTheme{
	
	public static final String DEFAULT_TEMPLATE = "fms2008/index";
    public static final String DEFAULT_HEADER = "fms2008/header";
    public static final String DEFAULT_FOOTER = "fms2008/footer";
    public static final String DEFAULT_STYLESHEET = "fms2008/default.css";
