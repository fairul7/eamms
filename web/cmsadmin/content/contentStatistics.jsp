...
<x:config>
<page name="contentStatistics">
    <portlet name="contentReportPortlet" text="<fmt:message key='cms.label.contentStatistics'/>" width="100%" permanent="true">
        <com.tms.cms.core.ui.ContentReportTable name="contentReportTable" width="100%" />
    </portlet>
</page>
</x:config>
            ...
            <tr>
              <td style="vertical-align: top;">
                ...
                <x:display name="cms.contentPath"/> <p>
                  ...
                  <%-- Content Listing --%>
                  <x:display name="contentStatistics.contentReportPortlet"/>
                <p> <br>
                  <br>
                  <br>
                  <br>
