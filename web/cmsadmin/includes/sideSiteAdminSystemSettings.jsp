          ...
          <tbody>
            <tr>
              <td style="background: #003366; vertical-align: top;">
                <span style="color: white; font-weight: bold;"><fmt:message key='siteadmin.label.systemSettings'/></span>
                <br>
              </td>
            </tr>
            <tr>
              <td style="background: #DDDDDD; vertical-align: top;">
                <li><a href="#" class="option"><fmt:message key='siteadmin.label.general'/></a></li>
                <br>
