...
<%--        <tr><td class="calendarRow"  colspan="2" class="forumFooter">&nbsp;</td></tr>--%>
...
<tr>
    ...
    <td class="calendarRow" >
        ...
        <x:display name="${form.validDescription.absoluteName}"/>
    </td>
</tr>
...
<tr>
    <td class="calendarRowLabel" width="23%" height="20" valign="top" align="right"  valign="top"><fmt:message key='calendar.label.Attendees'/></td>
    <td class="calendarRow" >
...
<tr>
    ...
    <td class="calendarRow" >
        <x:display name="${form.notifyMemo.absoluteName}"/><fmt:message key='calendar.label.Memo'/>
        <x:display name="${form.notifyEmail.absoluteName}"/><fmt:message key='calendar.label.Email'/>
        <!-- add in for send sms notification -->
        <%-- <x:display name="${form.notifySms.absoluteName}"/><fmt:message key='calendar.label.sms'/> --%>
    </td>
</tr>
