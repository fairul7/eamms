...
<table cellpadding="0" cellspacing="1" width="100%" border="0">
    ...
    <tr><td colspan="2" align="left" valign="top" class="title"><fmt:message key="calendar.label.Attendees"/> : </td></tr>
        ...
        <c:if test="${att.compulsory&&att.userId!=view.event.userId}" >
            ...
            <c:choose>
                <c:when test="${hasConflict}">
                    <c:set var="attFound" value="1"/>
                    <tr>
                        <td class="data" align="left" width="2" valign="top" valign="top"><input type="checkbox" name="comAttendeesCB" value="<c:out value="${att.userId}"/> " checked></td>
        ...
        <c:if test="${!att.compulsory}">
            ...
            <c:choose>
                <c:when test="${hasConflict}">
                    <c:set var="attFound" value="1"/>
                    <tr>
                        <td class="data" align="left" width="2" valign="top" valign="top"><input type="checkbox" name="opAttendeesCB" value="<c:out value="${att.userId}"/> " checked></td>
                        <td class="data" align="left" valign="top" valign="top"><font color="FF0000"><c:out value="${att.name}"/></font></td>
                    </tr>
                </c:when>
                <c:otherwise>
    ...
    <c:forEach items="${view.event.resources}" var="resource" >
        ...
        <c:choose>
            <c:when test="${hasConflict}">
                ...
                <tr>
                    <td class="data" align="left" width="2"><input type="checkbox" name="resourcesCB" value="<c:out value="${resource.id}"/> " checked></td>
