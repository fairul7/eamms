                                          ...
                                          <!--
                                              function popupSelectBoxOpen(absoluteName) {
                                                  ...
                                                  window.open('<c:url value="/mekms/popupSelectBox/popupFormWindow.jsp"/>?popupSelectBoxCn=' + absoluteName + '&popupFormWindowCn=' + formCn, "popupSelectBoxWindow", "height=400,width=600,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
                                                  return false;
                                              }
                                          ...
                                          --%>
                                                  ...
                                                  var sH = "<c:out value="${selectBox.absoluteName}"/>"+"hidden";
                                                  //var index = sH.lastIndexOf('.');
                                                  //var length = sH.length;
                                                  //sH = <c:out value="${selectBox.rootForm.absoluteName}"/>+"."+sH.substring(index+1,length)+"hidden";
                                                  //alert(sH);
                                                  hiddenValue = document.forms['<c:out value="${selectBox.rootForm.absoluteName}"/>'].elements[sH];
                                                  //alert(hiddenValue);
                                                  if (hiddenValue!=undefined) {
                                                      var s ="";
                                                      for (var c=0; c<targetBox.options.length; c++) {
                                                          if (c>0)
                                                            s+=","+targetBox.options[c].value;
                                                          else
                                                            s+=targetBox.options[c].value;
                                                      }
                                                      hiddenValue.value=s;
