...
<table  cellpadding="4" cellspacing="1" class="forumBackground" width="100%">
    <tr>
        <Td class="calendarHeader" colspan="2" ><fmt:message key='taskmanager.label.TaskResources'/></td>
    </tr>
    <tr>
        <Td class="calendarRowLabel" align="right" width="30%"><fmt:message key='taskmanager.label.Title'/></td>
        <td class="calendarRow" width="70%">
    ...
    <tr>
        ...
        <Td class="calendarRow">
            ...
            <%
                String description = "";
                description = StringUtils.replace((String)pageContext.getAttribute("description"),"\n","<br>");
