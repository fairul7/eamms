...
<table width="100%" border="" cellspacing="0" cellpadding="0"><tr><td>
...
%>
	<c:choose>
	<c:when test="${pageContext.request.requestURI == '/ekms/fms/transport/VehicleListing.jsp'}">
    ...
    <c:when test="${pageContext.request.requestURI == '/ekms/fms/facility/FacilityListing.jsp'}">
    ...
    <c:when test="${pageContext.request.requestURI == '/ekms/fms/transport/request/requestListing.jsp'}">
    ...
    <c:when test="${pageContext.request.requestURI == '/ekms/fms/engineering/requestListing.jsp'}">
...
<div id="ekmsTopMenu" style="position:absolute; width:235px; height:10px; z-index:100; top: 102px; visibility:hidden">
	...
	<td bgcolor="#aecc2e">
		...
		<%-- 
      	...
      	<td width="140" bgcolor="#f0f6dd">&nbsp;<a href="/ekms/messaging" class="dropmenu_text"><fmt:message key="theme.fms2008.messaging"/></a> </td>
    	--%>
    	</tr>
    	<tr>
