...
<script language="javascript">
	...
	function moveMember(strForm, strSrc, strDest) {
		var selSrc  = document.forms['resource.table'].elements['resource.table.comboSType.leftSelect'];
		var selDest = document.forms['resource.table'].elements['resource.table.comboSType.rightSelect'];
...
<table width="100%">
    ...
    <tr>
        <td width="45%" align="center">
            <b><div class="contentBgColor"><!--Available--><fmt:message key="comboSelectBox.available"/></div></b>
            <select
        ...
        <td width="45%" align="center">
            <b><div class="contentBgColor"><!--Selected--><fmt:message key="comboSelectBox.selected"/></div></b>
            <select
