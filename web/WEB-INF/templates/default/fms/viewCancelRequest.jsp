    ...
    <tr>
     ...
     <tr>
        ...
        <td class="classRow">
             ...
             <input value="<fmt:message key="fms.tran.cancelRequest"/>" type="button" class="button" onClick="window.open('cancelForm.jsp?requestId=<c:out value="${form.id}" />','rejectform','scrollbars=yes,resizable=yes,width=400,height=200');return false;"/>
