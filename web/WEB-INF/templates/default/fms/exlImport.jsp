	  ...
	  <table width="100%" border="0"  cellpadding="2" cellspacing="1" class="classBackground" >
        <tr>
          ...
          <td class="classRow">
            ...
            <a href = "/ekms/fms/SampleItems.xls" onClick="window.open('/ekms/fms/SampleItems.xls', 'check', 'scrollbars=yes,resizable=yes,width=400,height=200'); return false"><fmt:message key ='fms.label.transport.sample'/></a>
          </td>
    	</tr>
