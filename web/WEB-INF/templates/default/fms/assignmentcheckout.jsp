...
<c:if test="${! empty param.id}">
    ...
    <tr>
        <td  class="classRowLabel" width="23%" height="20" valign="top" align="right"  valign="top"><fmt:message key='fms.label.endDate'/>&nbsp; <FONT class="classRowLabel"></FONT></td>
        <td class="classRow">
    ...
    <tr>
        ...
        <td class="classRow">
            <x:display name="${form.time.absoluteName}" />
            <br>                        
        </td>
    </tr>
    <tr>
        ...
        <td class="classRow">
            <x:display name="${form.endSpeedoMeter.absoluteName}" />             
            <br>                        
        </td>
    </tr>
	<tr>
    ...
    <tr>
        ...
        <td class="classRow">       	 	
            <x:display name="${form.updateButton.absoluteName}" /><x:display name="${form.cancelButton.absoluteName}" />
            <br>                        
        </td>
    </tr>
