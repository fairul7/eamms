...
<c:if test="${selectBox.invalid}">!</c:if><select
	style="<c:if test="${selectBox.invalid}">border:1px solid #de123e;</c:if>background-color:#ffffff; text-decoration:none; font-family:Verdana, Arial, Helvetica, sans-serif;font-size:8pt; font-weight:normal"
