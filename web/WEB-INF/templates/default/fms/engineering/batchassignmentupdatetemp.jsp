...
<table width="100%" cellpadding="2" cellspacing="1" class="classBackground" >
    <tr>
         <td class="classRowLabel" width="23%" height="30" valign="top" align="right"  valign="top"><fmt:message key='fms.request.label.requestId'/></td>
         <td class="classRow" valign="top">
			<x:display name="${form.tfRequestId.absoluteName}" />
         </td>
    </tr>  
	<tr>
