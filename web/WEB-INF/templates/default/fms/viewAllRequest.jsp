...
<table width="100%" cellpadding="2" cellspacing="1" class="classBackground" >
    ...
    <tr>
        <td  class="classRowLabel" width="23%" height="20" valign="top" align="right"  valign="top"><fmt:message key='fms.tran.remarksFromApprover'/>&nbsp; <FONT class="classRowLabel"></FONT></td>
        <td class="classRow">
