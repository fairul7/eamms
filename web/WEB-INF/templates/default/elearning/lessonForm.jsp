...
<jsp:include page="../form_header.jsp"/>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="classBackground">
        ...
        <tr>
            ...
            <td class="classRowLabel" valign="top" align="left"><x:display name="${widget.childMap.folderId.absoluteName}"/></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            <td class="classRowLabel" valign="top" align="right"><fmt:message key="eLearning.lesson.label.associatedocuments"/></td>
        ...
        <tr>
            ...
            <td class="classRow"><x:display name="${widget.childMap.submit.absoluteName}"/> <input type="button" class="button" value="Cancel" onclick="self.location='lessons.jsp'"></td>
        </tr>
    </table>
