    ...
    <tr>
        <td>
            ...
            <table width="100%" cellpadding="3" cellspacing="1">
               ...
               <%--
                <tr>
                    <td class="classRowLabel" valign="top" align="right">Active</td>
                    <td class="classRow"><x:display name="${form.childMap.active.absoluteName}"/></td>
                </tr>
                  --%>
                <tr>
                ...
                <tr>
                    ...
                    <x:display name="${form.childMap.addFromQuestionBank.absoluteName}"/>
                    <x:display name="${form.childMap.viewQuestions.absoluteName}"/>
