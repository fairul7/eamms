                ...
                <!--
                    function <c:out value="${table.name}"/>_toggle(obj) {
                        ...
                        if (obj.checked) {
                            ...
                            <c:out value="${table.name}"/>_selectAll(document.getElementsByName('<c:out value="${table.tableRowName}"/>'));
                        }
                        else {
                            <c:out value="${table.name}"/>_deselectAll(document.getElementsByName('<c:out value="${table.tableRowName}"/>'));
                        }
                    }
