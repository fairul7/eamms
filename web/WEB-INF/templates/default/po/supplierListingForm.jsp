				...
				<table width="100%" cellpadding="3" cellspacing="1">
	                ...
	                <tr>
	                    <td height="22" class="contentTitleFont" colspan="2">
							<fmt:message key="po.label.prePurchase"/> > <fmt:message key="supplier.label.listing"/>
						</td>
	                </tr>
	                <tr>
...
<c:forEach items="${w.supplierTable}" var="supplierTable" varStatus = "status">
		        ...
		        <td>
			        ...
			        <tr>
			            <td class="contentBgColor" width="25%" valign="top" align="left" colspan="2">
						         <x:display name="${supplierTable.absoluteName}" />
						    	</td>
			                </tr>
		                	<jsp:include page="../form_footer.jsp" flush="true"/>
						</table>
