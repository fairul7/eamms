...
<!--
    function popupSelectBoxOpen(absoluteName) {
        ...
        window.open('<c:url value="/web/ekms/popupSingleSelect/popupFormWindowSingle.jsp"/>?popupSelectBoxCn=' + absoluteName + '&popupFormWindowCn=' + formCn, "popupSelectBoxWindow", "height=400,width=600,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
        return false;
    }
