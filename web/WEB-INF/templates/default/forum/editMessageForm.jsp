...
<table width="100%">
        <tr><td colspan="2"><span style="font-family:Arial; font-size:16px; font-weight:bold">Message Details</span></td></tr>
    <tr>
    ...
    <tr>
        <td valign="top"><fmt:message key="forum.label.messages"/></td>
