...
<table cellpadding="3" cellspacing="1" width="100%" class="forumBackground">
    ...
    <tr><td class="forumHeader" colspan="2">Forum Personalization</td></tr>
    <tr><td class="forumRow" colspan="2">&nbsp;</td></tr>
    <c:choose>
        <c:when test="${!(empty widget.entity)}">
            <tr>
                <td class="forumRowLabel" valign="top" align="right">Forums&nbsp;</td>
                <td class="forumRow"><x:display name="${widget.forums.absoluteName}"/></td>
            </tr>
            <tr>
                <td class="forumRowLabel" valign="top" align="right">Listing&nbsp;</td>
        ...
        <c:otherwise>
            <tr><td class="forumLabel" colspan="2">Entity ID Not Specified</td></tr>
            <tr><td class="forumRow" colspan="2">&nbsp;</td></tr>
        </c:otherwise>
    </c:choose>
