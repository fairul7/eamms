...
<table width="100%" cellpadding="0" cellspacing="0" class="forumBackground" >
<tr>
    <td style="vertical-align: top; font-size:10pt; font-weight: bold"><b>
    <fmt:message key="taxonomy.label.selectNode"/>
    <!-- Please select mapping node(s): -->
    </b></td>
</tr>
<tr>
    <td>
