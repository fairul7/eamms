...
<!--
    function popupSelectBoxOpen(absoluteName) {
        ...
        window.open('<c:url value="/ekms/assetmanagement/popupFormWindow.jsp"/>?popupSelectBoxCn=' + absoluteName + '&popupFormWindowCn=' + formCn, "popupSelectBoxWindow", "height=400,width=600,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
        return false;
    }
...
--%>
        ...
        window.location = "/ekms/assetmanagement/assetDisposalform.jsp";
