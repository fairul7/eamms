...
<c:if test="${w.personal}">
    <form action="<c:url value="/ekms/addressbook/abContactList.jsp" />" method="POST">
...
<x:cache key="contactSearchPortletIntranet" scope="application" time="300">
    <p>
    <form action="<c:url value="/ekms/addressbook/udContactList.jsp" />" method="POST">
...
<x:cache key="contactSearchPortletBusiness" scope="application" time="300">
    <p>
    <form action="<c:url value="/ekms/addressbook/bdContactList.jsp" />" method="POST">
