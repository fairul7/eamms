		...
		<td class="contentBgColor">
			...
			<c:choose>
				<c:when test="${w.suggestedResolutionDesc}">
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&suggestedResolutionDesc=false">Ascending</a>
				</c:when>
				<c:otherwise>
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&suggestedResolutionDesc=true">Descending</a>
				</c:otherwise>
			</c:choose>
			</div>
		...
		<td class="contentBgColor">
			...
			<c:choose>
				<c:when test="${w.remarksDesc}">
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&remarksDesc=false">Ascending</a>
				</c:when>
				<c:otherwise>
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&remarksDesc=true">Descending</a>
				</c:otherwise>
			</c:choose>
			</div>
		...
		<td class="contentBgColor">
			...
			<c:choose>
				<c:when test="${w.clarificationDesc}">
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&clarificationDesc=false">Ascending</a>
				</c:when>
				<c:otherwise>
					<a href="<c:out value='${pageContext.request.contextPath }' />/ekms/isr/requestorViewRequest.jsp?requestId=<c:out value="${param.requestId }"/>&clarificationDesc=true">Descending</a>
				</c:otherwise>
			</c:choose>
			</div>
