        ...
        <td>
			...
			<table border="0" cellpadding="4" cellspacing="4" style="border:0px solid gray" width="100%">
			  <tbody>
			    <tr>
			      <td class="fieldTitle">
			      	<fmt:message key="isr.label.resultPerPage"/>
			      </td>
			      <td >
			        <x:display name="${table.filterForm.childMap['pageSizeSelectBox'].absoluteName}"/>
			      </td>
			    </tr>
			    <tr>
			      <td class="fieldTitle">
			      <fmt:message key="isr.label.dateFrom"/>
			      </td>
			      <td>
			        <x:display name="${table.filterForm.childMap['fromDate'].absoluteName}"/> 
			        &nbsp;&nbsp;<b><fmt:message key="general.to" /></b>&nbsp;&nbsp;
			        <x:display name="${table.filterForm.childMap['toDate'].absoluteName}"/>
			      </td>
			    </tr>
			     <tr>
			      <td class="fieldTitle">
			      <fmt:message key="isr.label.adminPriority2"/>
			      </td>
			      <td>
			        <x:display name="${table.filterForm.childMap['sbPriority'].absoluteName}"/>
			      </td>
			    </tr>
			    <tr>
			      <td class="fieldTitle">
			      <fmt:message key="isr.label.reqDept"/>
			      </td>
			      <td>
			        <x:display name="${table.filterForm.childMap['sbRequestingDept'].absoluteName}"/>
			      </td>
			    </tr>
			    <tr>
			      <td class="fieldTitle">
			      <fmt:message key="isr.label.recDept"/>
			      </td>
			      <td>
			        <x:display name="${table.filterForm.childMap['sbReceivingDept'].absoluteName}"/>
			      </td>
			    </tr>
			    <tr>
			      <td>
			      ...
			      <td>
			      	<x:display name="${table.filterForm.childMap['filter'].absoluteName}"/>
