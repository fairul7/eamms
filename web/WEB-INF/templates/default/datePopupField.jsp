...
<input type=button name="<c:out value='${textfield.absoluteNameForJavaScript}'/>button1" value="V" onclick="<c:out value='${textfield.absoluteNameForJavaScript}'/>cal.toggle(document.forms[<c:out value='${textfield.rootForm.absoluteName}'/>].elements['button1'])">
