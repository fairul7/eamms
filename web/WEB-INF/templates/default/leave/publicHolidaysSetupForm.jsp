    ...
    <tr>
        <td>
            <table width="100%" cellpadding="3" cellspacing="1">
                ...
                <tr>
                    <td class="classRowLabel" valign="top" align="right" nowrap><fmt:message key='leave.label.holidayDate'/>&nbsp;<c:out value="*"/></td>
                    <td class="classRow" align="left"><x:display name="${form.holidayDate.absoluteName}"/></td>
                </tr>
                <tr>
                    <td class="classRowLabel" valign="top" align="right" nowrap><fmt:message key='leave.label.leaveDescription'/>&nbsp;<c:out value="*"/></td>
