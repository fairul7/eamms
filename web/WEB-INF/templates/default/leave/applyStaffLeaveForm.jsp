        ...
        <td>
            <table width="100%" cellpadding="3" cellspacing="1">
                <jsp:include page="../form_header.jsp" flush="true"/>
                    ...
                    <tr>
                        <td class="classRowLabel" valign="top" align="right"><fmt:message key='leave.label.employeeName'/></td>
                        <td class="classRow"><x:display name="${form.employeeList.absoluteName}"/></td>
                    </tr>
                    <tr>
