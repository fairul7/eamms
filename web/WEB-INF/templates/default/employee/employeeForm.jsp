    ...
    <tr>
        <td>
            <table width="100%" cellpadding="3" cellspacing="1">
                ...
                <tr>
                    <td class="classRowLabel" valign="top" width="30%" align="right"><fmt:message key='employee.label.user'/>&nbsp<c:out value="*"/></td>
                    <td class="classRow" align="left"><x:display name="${form.childMap.userNames.absoluteName}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="classRowLabel" valign="top" align="right"><fmt:message key='employee.label.dateJoined'/>&nbsp<c:out value="*"/></td>
                ...
                <tr>
                    <td class="classRowLabel" valign="top" align="right"><fmt:message key='employee.label.department'/>&nbsp<c:out value="*"/></td>
                    <td class="classRow" align="left"><x:display name="${form.childMap.department.absoluteName}"/></td>
                </tr>
                <tr>
                    <td class="classRowLabel" valign="top" align="right"><fmt:message key='employee.label.serviceClass'/>&nbsp<c:out value="*"/></td>
