...
<c:if test="${!empty table.path}">
	<table  cellSpacing=4 cellPadding=4  width="100%" >
    <tr>								
	<td> 
		<c:out value="${widgets['viewCategories.table'].path}" escapeXml="false"/>
	</td>
	</tr>
	</table>	
</c:if>
<c:if test="${!empty table.categoryName}">
<table  cellSpacing=4 cellPadding=4  width="100%" >
    <tr>								
	...
	<table class="discusson1" cellSpacing=4 cellPadding=4  width="100%" border=1>
       <tr>
        ...
        <td class="discusson_td" valign="top" align="left" ><i> <font class ="font_date"> &nbsp; &nbsp; &nbsp; created on :</i> <fmt:formatDate pattern="dd MM yyyy" value="${widgets['viewCategories.table'].categoryCreatedOn}"/> </font><td>
       </tr></table>
    </td></tr>
</table>
</c:if>
