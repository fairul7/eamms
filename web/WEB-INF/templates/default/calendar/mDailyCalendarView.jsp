...
<tr> <td VALIGN="BOTTOM"  BGCOLOR="#003366" CLASS="calendarFooter" >
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
        <td align="right" valign="bottom">

        <x:display name="${calendar.jumpForm.absoluteName}" ></td></x:display>
        <td align="right" valign="bottom"> xxxxxxx
...
<tr VALIGN="MIDDLE">
  ...
  %>
                    ...
                    <c:if test="${canAccept}" >
                     <input value="<fmt:message key="calendar.label.buttonAccept"/>" type="button" class="button" onClick="if(confirm('<fmt:message key="messaging.label.confirmDelete"/>')){document.location='<c:out value="${deleteUrl}"/>&eventId=<c:out value="${event.eventId}"/>';}"/>
                     <input value="<fmt:message key="calendar.label.buttonReject"/>" type="button" class="button" onClick="if(confirm('<fmt:message key="messaging.label.confirmDelete"/>')){document.location='<c:out value="${deleteUrl}"/>&eventId=<c:out value="${event.eventId}"/>';}"/>
                    </c:if>
                    </c:when>
