...
<tr><td class="calendarHeader" colspan="7"><fmt:message key='calendar.label.calendar'/> > <fmt:message key='calendar.label.monthlyCalendarView'/></td></tr>
...
<tr  ALIGN="CENTER">
    ...
    <c:choose>
        <c:when test="${dayOfWeek == sun || dayOfWeek == sat}" ><%--entry.dayOfWeekLabel == 'Sunday' || entry.dayOfWeekLabel == 'Saturday'--%>
