...
function initLeftMenu()
{
    ...
    if(document.getElementById("leftMenuShortcuts").style.display == "block")
        document.getElementById("leftMenuShortcutsImage").src = "/ekms/images/fms2008/leftMenuShortcuts_on.gif";
    else
        document.getElementById("leftMenuShortcutsImage").src = "/ekms/images/fms2008/leftMenuShortcuts_off.gif";
    if(document.getElementById("leftMenuSearch").style.display == "block")
        document.getElementById("leftMenuSearchImage").src = "/ekms/images/fms2008/leftMenuSearch_on.gif";
    else
        document.getElementById("leftMenuSearchImage").src = "/ekms/images/fms2008/leftMenuSearch_off.gif";
    if(document.getElementById("leftMenuHelp").style.display == "block")
        document.getElementById("leftMenuHelpImage").src = "/ekms/images/fms2008/leftMenuHelp_on.gif";
    else
        document.getElementById("leftMenuHelpImage").src = "/ekms/images/fms2008/leftMenuHelp_off.gif";
    if(document.getElementById("ekmsLeftMenu").style.display == "block")
        document.getElementById("leftMenuArrow").src = "/ekms/images/fms2008/but_arw_left.gif";
    else
        document.getElementById("leftMenuArrow").src = "/ekms/images/fms2008/but_arw_right.gif";
}
...
//Left tabs
function toggleLeftTabs(show, hide1, hide2, hide3)
{
	document.getElementById(show).style.display="block";
	document.getElementById(show + "Image").src="/ekms/images/fms2008/" + show + "_on.gif";
	document.getElementById(hide1).style.display="none";
	document.getElementById(hide1 + "Image").src="/ekms/images/fms2008/" + hide1 + "_off.gif";
	document.getElementById(hide2).style.display="none";
	document.getElementById(hide2 + "Image").src="/ekms/images/fms2008/" + hide2 + "_off.gif";
	document.getElementById(hide3).style.display="none";
	document.getElementById(hide3 + "Image").src="/ekms/images/fms2008/" + hide3 + "_off.gif";
	treeSave(show);
	treeSave(hide1);
	treeSave(hide2);
	treeSave(hide3);
