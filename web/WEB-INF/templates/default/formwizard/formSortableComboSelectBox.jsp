...
<%--                }--%>
                ...
                members.options[members.length] = o;
...
<%--                }--%>
                ...
                nonMembers.options[nonMembers.length] = o;
...
<table>
    <tr>
        <td width="45%" align="center">
            <b><fmt:message key="comboSelectBox.available"/></b><br>
            <select
        ...
        <td width="45%" align="center">
            <b><fmt:message key="comboSelectBox.selected"/></b><br>
            <x:display name="${comboSelectBox.rightSelect.absoluteName}"/>
            <%--<select
