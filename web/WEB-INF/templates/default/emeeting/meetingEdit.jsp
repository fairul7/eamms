...
<table cellpadding="4" cellspacing="1" width="100%">
    <c:if test="${!form.newResourceBooking}" >
        <tr>
            <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.title'/> *</td>
    ...
    <tr>
        <td class="calendarRowLabel" width="23%"  valign="top" align="right"><fmt:message key='emeeting.label.meetingCategory'/></td>
    ...
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.secretary'/></td>
        <td class="emeetingRow"><x:display name="${form.secretary.absoluteName}"/></td>
    </tr>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.documents'/></td>
        <td class="emeetingRow">
    ...
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.startDate'/> *</td>
        <td class="emeetingRow"><x:display name="${form.startDate.absoluteName}"/></td>
    </tr>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.endDate'/> *</td>
        <td class="emeetingRow"><x:display name="${form.endDate.absoluteName}"/></td>
    </tr>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.startTime'/></td>
        <td class="emeetingRow"><x:display name="${form.startTime.absoluteName}"/></td>
    </tr>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.endTime'/></td>
        <td class="emeetingRow">
    ...
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.location'/></td>
        <td class="emeetingRow"><x:display name="${form.location.absoluteName}"/></td>
    </tr>
        <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.classification'/></td>
        <td class="emeetingRow">
    ...
    <c:if test="${!form.newResourceBooking}" >
        <tr>
            <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.compulsoryAttendees'/></td>
            <td class="emeetingRow"><x:display name="${form.compulsory.absoluteName}"/></td>
        </tr>
        <tr>
            <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.optionalAttendees'/></td>
            <td class="emeetingRow"><x:display name="${form.optional.absoluteName}"/></td>
        </tr>
        <tr>
            <td class="calendarRowLabel" width="23%" height="20" valign="top" align="right"  valign="top"><fmt:message key='calendar.label.outsideAttendees'/></td>
            <td class="emeetingRow" ><x:display name="${form.outsideAttendee.absoluteName}"/></td>
        </tr>
    </c:if>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.resources'/></td>
        <td class="emeetingRow"><x:display name="${form.resources.absoluteName}"/></td>
    </tr>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.notifyMethod'/></td>
        <td class="emeetingRow">
...
<table cellpadding="4" cellspacing="1" width="100%">
<tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.reminder'/></td>
        <td class="emeetingRow">
    ...
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.description'/></td>
        <td class="emeetingRow"><x:display name="${form.description.absoluteName}"/></td>
    </tr>
    <c:if test="${!form.newResourceBooking}" >
        <tr>
            <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.agenda'/></td>
            <td class="emeetingRow"><x:display name="${form.agenda.absoluteName}"/></td>
        </tr>
    </c:if>
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.recurrence'/></td>
        <td class="emeetingRow">
            <div >
	...
	<c:if test="${!(form.notifyNote.hidden)}">
		<tr>
			<td class="calendarRowLabel" width="23%" valign="top" align="right"><fmt:message key='emeeting.label.notifyNote'/></td>
    ...
    <tr>
        <td class="calendarRowLabel" width="23%" valign="top" align="right">
        </td>
