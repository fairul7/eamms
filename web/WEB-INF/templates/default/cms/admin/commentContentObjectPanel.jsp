    ...
    <tr>
      ...
      <td style="vertical-align: top;">
        ...
        <c:if test="${co.score > 0}">
            [<b><c:forEach begin="0" end="${co.score - 1}">*</c:forEach></b>]
        </c:if>
      </td>
    </tr>
...
<%--
    <c:if test="${co.checkedOut}">
    <tr>
      <td style="vertical-align: top;">Checked Out<br>
      </td>
      <td style="vertical-align: top;">
        <c:out value="${co.checkOutUser}"/>,
    ...
    <c:if test="${co.submitted}">
    <tr>
      <td style="vertical-align: top;">Submitted<br>
      </td>
      <td style="vertical-align: top;">
        <c:out value="${co.submissionUser}"/>,
    ...
    <c:if test="${co.approved}">
    <tr>
      <td style="vertical-align: top;">Approved<br>
      </td>
      <td style="vertical-align: top;">
        <c:out value="${co.approvalUser}"/>,
