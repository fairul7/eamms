...
<c:set var="co" scope="request" value="${widget}"/>
      ...
      <table cellpadding="1" cellspacing="0" border="0" style="text-align: left; width: 100%; border:1px solid gray; background: 003366">
          <tbody>
            <tr>
...
<%--                <x:event name="${co.absoluteName}" html="class='option'" type="Preview"><fmt:message key='general.label.previewContent'/></x:event>--%>
              </td>
            </tr>
            </c:if>
            ...
            <tr>
              <td class="optionheader">
                <fmt:message key='cms.label.publishingAndArchiving'/>
              </td>
            </tr>
            ...
            <tr>
              <td class="optionheader">
                <fmt:message key='cms.label.securityAndAuditing'/>
              </td>
            </tr>
