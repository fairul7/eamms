...
<table cellpadding="2" cellspacing="2" border="0" style="text-align: left; width: 100%;">
    <tbody>
        ...
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.score'/>&nbsp;</td>
            <td style="vertical-align: top;"><x:display name="${form.childMap.scoreGroup.absoluteName}"/></td>
        </tr>
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.comment'/>&nbsp;</td>
