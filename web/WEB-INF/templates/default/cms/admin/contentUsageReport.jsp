...
<table width="100%" cellpadding="4" cellspacing="1">
	...
	<tr>
		...
		<td>
			...
			<a href="#" onclick="javascript:window.open('contentUsageReportDetails.jsp?sectionId=<c:out value='${v.contentSectionId}'/>&groupId=<c:out value='${v.groupId}'/>', 'profileWindow', 'height=300,width=250,left=50,top=50,screenx=50,screeny=50,scrollbars=yes,resizable=yes');return false;">
