...
<table cellpadding="2" cellspacing="2" border="0" style="text-align: left; width: 100%;">
    <tbody>
        ...
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.url'/>&nbsp;</td>
            <td style="vertical-align: top;"><x:display name="${form.childMap.urlField.absoluteName}"/><a href="#" onclick="window.open('bookmarkSelector.jsp','bookmarkSelector','status=yes,scrollbars=yes,resizable=yes,width=700,height=460'); return false" target="_blank"><fmt:message key='general.label.selectContent'/></a></td>
        </tr>
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.targetWindow'/>&nbsp;</td>
            <td style="vertical-align: top;"><x:display name="${form.childMap.targetField.absoluteName}"/></td>
        </tr>
        <tr>
        ...
        <tr><td style="vertical-align: top;" colspan="2" class="contentTitleFont" height="22">&nbsp;<fmt:message key='general.label.metaInformation'/></td></tr>
        <c:choose>
