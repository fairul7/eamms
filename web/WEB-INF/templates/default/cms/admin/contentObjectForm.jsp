...
<table cellpadding="2" cellspacing="2" border="0" style="text-align: left; width: 100%;">
    <tbody>
        ...
        <tr><td height="22" colspan="2"  class="contentTitleFont">&nbsp;<fmt:message key='general.label.content'/></td></tr>
        <tr>
            <td align="right" style="vertical-align: top;" class="classRowLabel"><fmt:message key='general.label.abstract'/>&nbsp;</td>
            <td style="vertical-align: top;">
                <table width="100%" cellpadding="0">
                    <tr><td><x:display name="${form.childMap.summaryBox.absoluteName}"/></td></tr>
                </table>
            </td>
        </tr>
        <jsp:include page="contentObjectProfileForm.jsp" flush="true" />
        <tr><td height="22" colspan="2" class="contentTitleFont">&nbsp;<fmt:message key='general.label.metaInformation' /></td></tr>
        <c:choose>
            <c:when test="${!empty co && !empty co.id}">
                <tr>
                    <td align="right" style="vertical-align: top; width: 150px;" class="classRowLabel"><fmt:message key='general.label.id'/>&nbsp;</td>
            ...
            <c:otherwise>
                <tr>
                    ...
                    <td style="vertical-align: top;">
                        <table width="100%" cellpadding="0">
                            <tr><td><x:display name="${form.childMap.idField.absoluteName}"/></td></tr>
                        </table>
                    </td>
                </tr>
            </c:otherwise>
        ...
        <tr>
            <td align="right" style="vertical-align: top;" class="classRowLabel"><fmt:message key='general.label.description'/>&nbsp;</td>
            <td style="vertical-align: top;">
                <table width="100%" cellpadding="0">
                    <tr><td><x:display name="${form.childMap.descriptionBox.absoluteName}"/></td></tr>
                </table>
            </td>
        </tr>
        <tr><td height="22" style="vertical-align: center;" colspan="2" class="contentTitleFont">&nbsp;<fmt:message key='general.label.publication'/>&nbsp;</td></tr>
        <tr>
            <td align="right" style="vertical-align: top;" class="classRowLabel"><fmt:message key='general.label.publishingSchedule'/>&nbsp;</td>
            <td style="vertical-align: top;">
                <table cellpadding="2">
