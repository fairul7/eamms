...
<table cellpadding="2" cellspacing="2" border="0" style="text-align: left; width: 100%;">
    <tbody>
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.upload'/>&nbsp;</td>
            <td style="vertical-align: top;"><x:display name="${form.childMap.fileUpload.absoluteName}"/></td>
        </tr>
        <c:if test="${!empty co && !empty co.fileName}">
            <tr>
                <td style="vertical-align: top;"><fmt:message key='general.label.existingFile'/>&nbsp;</td>
            ...
            <tr>
                <td style="vertical-align: top;"><fmt:message key='general.label.contentType'/>&nbsp;</td>
                <td style="vertical-align: top;"><c:out value="${co.contentType}"/></td>
            </tr>
            <tr>
                <td style="vertical-align: top;"><fmt:message key='general.label.fileSize'/>&nbsp;</td>
        ...
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.byLine'/>&nbsp;</td>
            <td style="vertical-align: top;"><x:display name="${form.childMap.authorField.absoluteName}"/></td>
        </tr>
        <tr>
            <td style="vertical-align: top;" class="classRowLabel" align="right"><fmt:message key='general.label.caption'/>&nbsp;</td>
        ...
        <tr><td style="vertical-align: top;" colspan="2" class="contentTitleFont" height="22">&nbsp;<fmt:message key='general.label.publication'/></td></tr>
        <tr>
