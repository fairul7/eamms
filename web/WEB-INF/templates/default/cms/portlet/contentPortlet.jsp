        ...
        <td>
            <table cellpadding="0" cellspacing="1" width="95%" align="center">
                <c:choose>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <%
                                                        ...
                                                        {
                                                    %>
                                                    <font size="-2">[<font color="FF0000">NEW</font>]</font>
                                                    <%
                                                        }
                                                    %>
                                                    <br>
                                                    ...
                                                    <font class="articleSmall">
                                                        ...
                                                        <fmt:formatDate value="${article.date}"/> | Views:
                    ...
                    <c:otherwise>
                        <tr><td class="articleBody"><fmt:message key='cms.label.noArticles'/></td></tr>
                        <tr><td class="articleBody">&nbsp;</td></tr>
                    </c:otherwise>
                </c:choose>
            </table>
            ...
            <x:permission permission="<%= ContentManager.PERMISSION_MANAGE_CONTENT %>" module="<%= ContentManager.class.getName() %>">
                ...
                <!--
                    function newDocument(){
                        window.open('<c:url value="/ekms/content/popup/newDocument.jsp"/>','newContentPopup','scrollbars=yes,resizable=yes,width=700,height=500')
                    }
                    function newArticle(){
                ...
                <input class="button" value="<fmt:message key='cms.label.newDocument'/>" type="button" onClick="newDocument()"/>
                <img src="images/blank.gif" width="1" height="15">
                <input class="button" value="<fmt:message key='cms.label.newArticle'/>" type="button" onClick="newArticle()"/>
            </x:permission>
        </td>
    </tr>
</table>