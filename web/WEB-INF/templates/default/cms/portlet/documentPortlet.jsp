        ...
        <td>
            <table cellpadding="0" cellspacing="1" width="95%" align="center">
                <c:choose>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <%
                                                        ...
                                                        {
                                                    %>
                                                    <font size="-2">[<font color="FF0000"><fmt:message key="portlet.documents.new"/></font>]</font>
                                                    <%
                                                        }
                                                    %>
                                                    <br>
                                                    ...
                                                    <font class="articleSmall">
                                                        ...
                                                        <fmt:formatDate value="${article.date}"/> | <fmt:message key="portlet.documents.views"/>:
                    ...
                    <c:otherwise>
                        <tr><td class="articleBody"><fmt:message key="portlet.documents.noDocuments"/></td></tr>
                        <tr><td class="articleBody">&nbsp;</td></tr>
                    </c:otherwise>
                </c:choose>
            </table>
    ...
    <tr>
        <td class="portletFooter">
            ...
            <x:permission permission="<%= ContentManager.PERMISSION_MANAGE_CONTENT %>" module="<%= ContentManager.class.getName() %>">
                ...
                <input class="button" value="<fmt:message key="portlet.documents.newDocument"/>" type="button" onClick="newDocument()"/>
            </x:permission>
        </td>
    </tr>
</table>