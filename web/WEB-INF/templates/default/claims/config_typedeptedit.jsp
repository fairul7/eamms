			...
			<table width="100%" cellpadding="3" cellspacing="1">
				...
				<tr>
					<td class="classRowLabel" valign="top" align="right">
						<x:display name="${form.childMap.typeLabel.absoluteName}" />
					</td>
					<td class="classRow">
						<x:display name="${form.childMap.typeLabelText.absoluteName}" />
					</td>
				</tr>
				
				<tr>
					<td class="classRowLabel" valign="top" align="right">
						<x:display name="${form.childMap.departmentLabel.absoluteName}" />
					</td>
					<td class="classRow">
						<x:display name="${form.childMap.departmentBox.absoluteName}" />
					</td>
				</tr>
