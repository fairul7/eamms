...
<table cellpadding="3" cellspacing="0" width="100%">
    <tr><td class="contentTitleFont"><span class="contentTitleFont"><fmt:message key="general.label.search"/></span></td></tr>
            ...
            <table cellpadding="0" cellspacing="0" width="95%">
                <tr>
                    <td>
                        ...
                        <!-- Search Results -->
                        <c:forEach var="result" items="${searchWidget.searchResultsSummary}">
                            <c:choose>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="95%">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <c:if test="${result.value.totalSize > searchWidget.summaryPageSize}">
                                                            <p class="contentPaging">
                                                            [ <a href="?query=<c:out value='${param.query}'/>&<c:out value='${searchModule}'/>=<c:out value='${result.key}'/>&<c:out value="${searchType}"/>=<c:out value="${widget.selectedSearchType[result.key]}"/>">More - <c:out value="${result.value.totalSize}"/> Results</a> ]
                                                            </p>
                                                            </c:if>
                                                        </td>
                                                    </tr>
