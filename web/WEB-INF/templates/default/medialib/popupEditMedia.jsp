...
<table width="100%" border="0" cellspacing="0" cellpadding="5" >
	<tr valign="middle">
		<td height="22" class="contentTitleFont">
			<fmt:message key="medialib.label.editMedia"/>
		</td>
	</tr>
				...
				<tr>
					...
					<td class="thumbnailBorder" rowspan="<c:out value='${rowspan}'/>" width="130">
						...
						<c:when test="${mediaType eq 'image'}">
							<a href="popupViewMedia.jsp?id=<c:out value="${w.mediaId}"/>">
...
<script language="JavaScript">
	if(navigator.appName == 'Netscape') {
		document.forms['<c:out value="${w.absoluteName}"/>'].elements['<c:out value="${w.libraryName.absoluteName}"/>'].onChange = setLibraryAlbumChange();
	}
</script>