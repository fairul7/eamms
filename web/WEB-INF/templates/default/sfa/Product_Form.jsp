...
<c:when test="${form.type == 'View'}">
	<table border="1" cellpadding="2" cellspacing="0" class="formStyle" width="<c:out value="${form.width}"/>">
		<tr>
			...
			<td valign="top" width="75%"><x:display name="${form.absoluteName}.lbProductText"/></td>
		</tr>
		<tr>
...
<c:when test="${form.type == 'Edit' or form.type == 'Add'}">
	<table border="1" cellpadding="2" cellspacing="0" class="formStyle" width="<c:out value="${form.width}"/>">
		<tr>
			...
			<td valign="top" width="75%"><x:display name="${form.absoluteName}.category"/></td>
		</tr>
		<tr>
			<td valign="top" width="25%"><b><fmt:message key='sfa.message.product&Name'/>:&nbsp; *</b></td>
			<td valign="top" width="75%"><x:display name="${form.absoluteName}.tf_ProductName"/></td>
		</tr>
		<tr>
			<td valign="top"><b><fmt:message key='sfa.message.archived'/>:&nbsp;</b></td>
