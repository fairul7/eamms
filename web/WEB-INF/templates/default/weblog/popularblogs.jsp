...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr><td colspan="3" class="blogHeader"><fmt:message key='weblog.label.mostPopularWeblogs'/></td></tr>
    ...
    <tr>
        ...
        <td class="blogLabel"><fmt:message key='weblog.label.hits'/></td>
    </tr>
    ...
    <c:forEach var="blog" items="${blogs}">
		<tr>
			...
			<td class="blogRow"><c:out value="${blog.hits}" /></td>
		</tr>
    </c:forEach>
</table>
