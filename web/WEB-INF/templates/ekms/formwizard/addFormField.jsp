...
<tr>
    <td colspan = "2">
        <div id = "note" style='display:<c:out value="${note}"/>'>
  		    <table width = "100%">
                <tr>
                    <td valign="top" align="center" ><font color="red"><fmt:message key='formWizard.message.field.note'/></font></td>
                </tr>
            </table>
        </div>
    </td>
...
<%
    ...
    if(wm!=null) {
  	    AddG2FieldForm form = (AddG2FieldForm)wm.getWidget("ekmsAddG2FieldFormPage.ekmsAddG2FieldForm");
        if (form != null) {
%>
