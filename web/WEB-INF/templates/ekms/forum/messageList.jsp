...
<table border="0" align="center" cellspacing="1" cellpadding="4" class="forumBackground" width="100%">
    <form method="post">
        ...
        <tr><td class="forumFooterLabel" colspan="2"><fmt:message key='forum.label.contents'/></td></tr>
        <tr>
        ...
        <tr><td class="forumFooterLabel" colspan="2"><fmt:message key='forum.label.topicThreads'/></td></tr>
        ...
        <c:choose>
            <c:when test="${empty list.postedMessages}">
                <tr><td class="forumRow" colspan="2"><fmt:message key='forum.label.noMessageFound'/></td></tr>
            </c:when>
            <c:otherwise>
                            ...
                            <table cellpadding="3" cellspacing="0" width="100%">
                                <tr>
                                    <td colspan="2" class="forumListSmall">
                                        <b><fmt:message key='forum.label.postedby'/>:</b> <c:out value="${postedMessage.ownerId}"/><br>
                                        <b><fmt:message key='forum.label.subject'/>:</b>
