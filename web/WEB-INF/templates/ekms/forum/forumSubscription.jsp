...
<tr>
    <td width="30%" nowrap class="forumRowLabel" valign="top" align="right"><fmt:message key='forum.label.subscriptions'/>&nbsp;</td>
    <td width="70%" class="forumRow"><x:display name="${widget.forums.absoluteName}"/></td>
</tr>
<tr>
    <td width="30%" nowrap class="forumRowLabel" valign="top" align="right"><fmt:message key='forum.label.forumType'/>&nbsp;</td>
