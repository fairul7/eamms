...
<table width="100%" class="contentBgColor" cellpadding="4" cellspacing="1">
    <tr><td colspan="2" class="contentTitleFont"><fmt:message key='forum.label.editForum'/></td></tr>
    <tr>
    ...
    <tr>
        <td valign="top" class="classRowLabel" align="right"><fmt:message key='forum.lable.adduser'/></td>
