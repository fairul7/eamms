...
<table width="100%" class="forumBackground" cellpadding="4" cellspacing="1">
    <tr><td colspan="2" class="forumHeader"><fmt:message key='forum.label.topicDetails'/></td></tr>
    <tr>
    ...
    <tr>
        <td class="forumRowLabel" valign="top"><fmt:message key='forum.label.status'/></td>
        <td class="forumRowLabel"><x:display name="${form.active.absoluteName}"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="forumRowLabel" valign="top"><fmt:message key='forum.label.description'/></td>
