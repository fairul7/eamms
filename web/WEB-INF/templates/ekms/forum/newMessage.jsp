...
<table border="0" align="center" cellspacing="1" cellpadding="4" class="forumBackground" width="100%">
    <form name="newThreadForm" action="" method="POST">
        <tr><td colspan="2" class="forumHeader"><fmt:message key="general.label.forum"/> > <fmt:message key='forum.label.postNewMessage'/></td></tr>
        ...
        <c:choose>
            <c:when test="${empty form.parentMessage}">
                ...
                %>
                <tr><td colspan="2" class="forumLabel"><fmt:message key='forum.label.originalAuthor'/>: <c:out value="${form.thread.ownerId}" /></td></tr>
            ...
            <c:otherwise>
                <%
                    ...
                    pageContext.setAttribute("content", content);
                %>
                <tr><td colspan="2" class="forumLabel"><fmt:message key='forum.label.originalAuthor'/>: <c:out value="${form.parentMessage.ownerId}" /></td></tr>
                <tr><td colspan="2" class="forumRow"><c:out escapeXml="false" value="${content}"/></td></tr>
            </c:otherwise>
        </c:choose>
        <tr>
