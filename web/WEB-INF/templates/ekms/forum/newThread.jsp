...
<table cellpadding="4" cellspacing="1" class="forumBackground" width="100%">
    <form name="newThreadForm" action="" method="POST">
        <tr><td colspan="2" class="forumHeader"><fmt:message key="general.label.forum"/> > <fmt:message key='forum.label.startNewTopic'/></td></tr>
        <tr><td colspan="2" class="forumFooter">&nbsp;</td></tr>
        <tr>
            <td colspan="2" class="forumRow">
                <a href="forums.jsp"><fmt:message key="general.label.forums"/></a>
                &gt; <a href="forumTopicList.jsp?forumId=<c:out value="${form.forumId}" />"><c:out value="${form.forumName}" /></a>
                &gt; <fmt:message key='forum.label.newTopic'/>
            </td>
        </tr>
        ...
        <tr>
            <td class="forumRowLabel" width="23%" height="20" valign="top" align="right">
                ...
                <fmt:message key="forum.label.subject"/>&nbsp; <FONT class="forumRowLabel">*</FONT>
            </td>
