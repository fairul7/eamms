...
<tr>
  <td><fmt:message key='com.tms.quotation.sortTemplate'/></td>
</tr>
</table>

<table width="100%" border="0" cellspacing="6" cellpadding="0" class="contentBgColor">
<tr>
  <td align="right" valign="top" width="15%"><b><fmt:message key='com.tms.quotation.sortTemplate.items'/><!---marker---></b></td>
  <td><x:display name="${form.childMap.sbSortTemplateBox.absoluteName}" /><br/></td>
</tr>
<tr>
