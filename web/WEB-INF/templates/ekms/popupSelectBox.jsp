...
<input type="button" class="button" name="<c:out value="${selectBox.absoluteNameForJavaScript}_selectButton"/>" onclick="return <c:out value="${selectBox.absoluteNameForJavaScript}"/>_popupSelectBoxOpen('<c:out value="${selectBox.absoluteName}"/>')" value="<fmt:message key="popupSelectBox.select"/>">
...
<script>
<!--
  function <c:out value="${selectBox.absoluteNameForJavaScript}"/>_popupSelectBoxOpen(absoluteName) {
