...
<c:choose>
    ...
    <input
style="border:0px solid #F0F6DD;background-color:#F0F6DD;text-decoration:none; font-family:Verdana, Arial, Helvetica, sans-serif;font-size:8pt; font-weight:normal"
