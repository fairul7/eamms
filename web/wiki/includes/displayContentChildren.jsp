...
<tr>
    <td valign=top align=left colspan=3><span class="sectionHeader2"></span></td>
</tr>

<c:forEach var="co" items="${children}">
    <tr>
    <td valign=top align=left valign="top" width="100"><span class="tsBody3"><fmt:formatDate pattern="${globalDateLong}" value="${co.date}"/></span></td>
    <td valign=top align=left width=10 valign="top">
        <c:choose>
            <c:when test="${co.className == 'com.tms.cms.article.Article'}">
                <img src="images/ic_article.gif" border="0" alt="Article">
            </c:when>
            <c:when test="${co.className == 'com.tms.cms.document.Document'}">
                <img src="images/ic_document.gif" border="0" alt="Document">
            </c:when>
            <c:when test="${co.className == 'com.tms.cms.page.Page'}">
                <img src="images/ic_article.gif" border="0" alt="Page">
            </c:when>
        </c:choose>
    </td>
