...
<%-- Process Actions --%>
<x:template type="TemplateProcessLoginForm" properties="forward=../wiki/index.jsp" />
<x:template type="TemplateProcessForgetPasswordForm" properties="forward=../wiki/index.jsp" />
