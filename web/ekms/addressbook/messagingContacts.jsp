...
<x:config>
    ...
    <panel name="panel1" text="<fmt:message key="addressbook.label.intranetUsers"/>">
        <com.tms.collab.directory.ui.UserMessagingTable name="table2" sort="username" />
    </panel>
    <panel name="panel2" text="<fmt:message key="addressbook.label.businessDirectory"/>">
        <com.tms.collab.directory.ui.DirectoryContactMessagingTable name="table3" sort="firstName" />
    </panel>
    <panel name="panel3" text="<fmt:message key="addressbook.label.personalContacts"/>">
