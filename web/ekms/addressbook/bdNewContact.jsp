...
<x:config>
    <page name="bdNewContact">
        <com.tms.collab.directory.ui.DirectoryContactNewForm name="form" />
    </page>
</x:config>

<%@include file="includes/folderTreeAction.jsp" %>

<c:if test="${!empty param['button*bdNewContact.form.buttonPanel.cancel_form_action']}">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;<fmt:message key='addressbook.label.menu.businessDirectory'/> > <fmt:message key='addressbook.label.businessDirectoryNewContact'/>
    </font></b></td>
  ...
  <tr>
    <td colspan="2" valign="TOP">
        <x:display name="bdNewContact.form" />
    </td>
  </tr>
  <tr>
