...
<x:config>
    <page name="abContactList">
        <com.tms.collab.directory.ui.ContactTable name="table" sort="firstName" />
    </page>
</x:config>
...
<c-rt:set var="forwardNewContactGroup" value="<%= ContactTable.FORWARD_NEW_CONTACT_GROUP %>"/>
<c:if test="${forward.name eq forwardNewContactGroup}">
    <c:redirect url="abNewContactGroup.jsp" />
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;<fmt:message key='addressbook.label.personalContacts'/> > <fmt:message key='addressbook.label.contactGroupContacts'/>
    </font></b></td>
