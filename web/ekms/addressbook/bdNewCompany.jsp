...
<x:config>
    <page name="bdNewCompany">
        <com.tms.collab.directory.ui.CompanyNewForm name="form" />
    </page>
</x:config>

<%@include file="includes/folderTreeAction.jsp" %>

<c:if test="${!empty param['button*bdNewCompany.form.buttonPanel.cancel_form_action']}">
...
<c:if test="${forward.name eq forwardPending}">
    <script>
    <!--
        alert("<fmt:message key="addressbook.label.companySubmitted"/>");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;<fmt:message key='addressbook.label.businessDirectoryNewCompany'/>
    </font></b></td>
  ...
  <tr>
    <td colspan="2" valign="TOP">
        <x:display name="bdNewCompany.form" />
    </td>
  </tr>
  <tr>
