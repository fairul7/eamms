...
%>
    ...
    <input type="button" class="button" value="<fmt:message key='sfa.message.back'/>" onClick="location = 'opportunity_details.jsp'"/>

<%--
	<a href=""><fmt:message key='sfa.message.edit'/></a>
--%>
<%--
	<br>
