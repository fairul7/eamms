...
<x:set name="incidentCompany.table1" property="linkUrl" value="incidentCompanyView.jsp" />
<c:choose>
    <c:when test="${forward.name == 'companyAdded'}">
        <c:set var="justCreatedID" value="${widgets['incidentCompany.form1'].justCreatedID}" />
    ...
    <c:when test="${forward.name == 'selectCompany'}">
        <c:redirect url="incidentContact.jsp?companyId=${widgets['incidentCompany.table1'].selectedCompanyID}&clear=1"/>
    </c:when>
</c:choose>
...
<table cellpadding="4" cellspacing="1" class="sfaBackground" width="100%">
    ...
    <tr>
        <td class="sfaRow">
            ...
            <x:display name="incidentCompany.table1"/>
        </td>
    </tr>
</table>
<br>
...
<table cellpadding="4" cellspacing="1" class="sfaBackground" width="100%">
    ...
    <tr>
        <td class="sfaHeader">
            ...
            <fmt:message key="com.tms.crm.helpdesk.HelpdeskHandler"/> > <fmt:message key='sfa.message.newCompany'/>
        </td>
    </tr>
    <tr>
        <td class="sfaRow">

            <x:display name="incidentCompany.form1"></x:display>
        </td>
    </tr>
</table>
