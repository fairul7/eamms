...
<x:config>
    <page name="setupdigestissueopen">
     	<com.tms.cms.digest.ui.SetupDigestIssueForm name="setupdigestissueformopen" type="edit" width="100%" />
    </page>
</x:config>
...
<c:if test="${forward.name == forward_success}">
    <script>
        alert("<fmt:message key='digest.label.digestIssueUpdated'/>");
        document.location = "setupDigestIssue.jsp";
    </script>
</c:if>
<c:if test="${!(empty param.digestIssueId)}">
    <x:set name="setupdigestissueopen.setupdigestissueformopen" property="digestIssueId" value="${param.digestIssueId}"/>
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;
      <fmt:message key='digest.label.updateDigestIssue'/>
    </font></b></td>
  ...
  <tr>
	...
	<x:display name="setupdigestissueopen.setupdigestissueformopen"></x:display>
    </td>
  </tr>
  <tr>
