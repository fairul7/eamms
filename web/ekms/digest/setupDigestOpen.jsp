...
<x:config>
    <page name="setupdigestopen">
     	<com.tms.cms.digest.ui.SetupDigestForm name="setupdigestformopen" type="edit" width="100%" />
    </page>
</x:config>
...
<c:if test="${forward.name == forward_success}">
    <script>
        alert("<fmt:message key='digest.label.digestUpdated'/>");
        document.location = "setupDigest.jsp";
    </script>
</c:if>
<c:if test="${!(empty param.digestId)}">
    <x:set name="setupdigestopen.setupdigestformopen" property="digestId" value="${param.digestId}"/>
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;
      <fmt:message key='digest.label.updateDigest'/>
    </font></b></td>
  ...
  <tr>
	...
	<x:display name="setupdigestopen.setupdigestformopen"></x:display>
    </td>
  </tr>
  <tr>
