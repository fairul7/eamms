...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;  <fmt:message key='messaging.label.pOP3AccountListing'/> > <fmt:message key='messaging.label.editPOP3Account'/>
    </font></b></td>
  ...
  <tr>
    <td colspan="2" valign="TOP">
        ...
        <x:template name="pop3AccountLog" type="com.tms.collab.messaging.ui.Pop3AccountLog" properties="accountId=${widgets['editPop3AccountPage.form'].accountId}" />
    </td>
  </tr>
  <tr>
