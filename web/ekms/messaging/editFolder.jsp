...
<c-rt:set var="forwardCancel" value="<%= EditFolderForm.CANCEL_FORM_ACTION %>" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr valign="MIDDLE">
    <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont">
      &nbsp;<fmt:message key='messaging.label.managerFolder'/> > <fmt:message key='messaging.label.editFolder'/>
    </font></b></td>
