...
<c:if test="${!empty param.id}">
    ...
    <c:if test="${!empty param.page}">
        <x:set name="txy_tree_page.txy_result" property="page" value="${param.page}"/>
    </c:if>
    <c:if test="${empty param.page}">
        <x:set name="txy_tree_page.txy_result" property="page" value="1"/>
    </c:if>        
...
<c:if test="${empty param.id}">
    ...
    <x:set name="txy_tree_page.txy_result" property="page" value="0"/>
...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
	<tr>
		<td>
		<x:display name="txy_tree_page.txy_tree"/>
		</td>
	</tr>
	<tr><td  class="contentBody"><x:display name="txy_tree_page.txy_result"/> <br></td></tr>
	<tr><td><x:display name="txy_tree_page.txy_related"/></td></tr>
	<tr><td align="right">[ <a href="taxonomySearch.jsp" class="indication"><fmt:message key="taxonomy.label.advancesearch" /></a> ]</td></tr>
</table>
