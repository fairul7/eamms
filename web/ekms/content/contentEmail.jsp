...
<form method="post" action="contentEmail.jsp?id=<c:out value='${param.id}'/>">
  <table border="0">
    <tr valign="top">
      <td><b><font face="arial, helvetica, sans-serif" size="2" class="tstextbold"><fmt:message key='cms.label.emailTo'/>:</font></b></td>
      <td><input type="text" name="emailto" size="30" maxlength="255" value="<c:out value='${param.emailto}'/>"></td>
    </tr>
    <tr valign="top">
      <td><b><font face="arial, helvetica, sans-serif" size="2" class="tstextbold"><fmt:message key='cms.label.yourEmail'/>:</font></b></td>
      <td><input type="text" name="emailfrom" size="30" maxlength="255" value="<c:out value='${param.emailfrom}'/>"></td>
    </tr>
    <tr valign="top">
      <td><b><font face="arial, helvetica, sans-serif" size="2" class="tstextbold"><fmt:message key='cms.label.comments'/>:</font></b></td>
