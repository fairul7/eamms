...
<x:config>
<page name="contentPreview">
    <portlet name="previewContentPortlet" text="<fmt:message key='cms.label.contentPreview'/>" width="100%" permanent="true">
        <com.tms.cms.core.ui.PreviewContentObjectPanel name="previewContentObjectPanel"/>
    </portlet>
</page>
</x:config>
            ...
            <tr>
              <td style="vertical-align: top;"><br>
                ...
                <x:display name="cms.contentPath"/> <p>
                  ...
                  <%--Content Details--%>
                  <x:display name="contentPreview.previewContentPortlet"/>
                  <br>
                  <br>
                  <br>
                  <br>
