<%@page import="java.text.SimpleDateFormat,
				...
				com.tms.report.ui.ContentSubmittedReport,
...
<%
	...
	ContentSubmittedReport report = (ContentSubmittedReport)Application.getInstance().getWidget(request, "contentSubmittedReportPg.contentSubmittedReport");
	
	Collection col = report.getResults();
	
	csvp.write(new String[] {"Content Submitted Report"} );
    csvp.writeln();
    csvp.writeln();
    ...
    String fileName = "content_submitted_report_" + dateFormat.format(calendar.getTime()) + ".csv";
