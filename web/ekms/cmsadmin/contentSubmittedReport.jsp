...
function generateCsv() {
	document.location = "genContentSubmittedReportCSV.jsp";
	return false;
}
</script>

<x:config>
    <page name="contentSubmittedReportPg">
        <com.tms.report.ui.ContentSubmittedReport name="contentSubmittedReport"/>
    </page>
</x:config>
...
<c:set var="bodyTitle" scope="request"><fmt:message key="com.tms.report"/> - Content Submitted Report</c:set>
<jsp:include page="/ekms/includes/bodyHeader.jsp" flush="true"/>

<x:display name="contentSubmittedReportPg.contentSubmittedReport"/>
