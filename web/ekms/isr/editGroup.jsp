...
<x:config>
	<page name="permission">
		<com.tms.collab.isr.permission.ui.EditPermissionForm name="editPermissionForm"/>
    </page>
</x:config>

<c:if test="${!empty param.id }">
	<x:set name="permission.editPermissionForm" property="groupId" value="${param.id }" />
</c:if>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" valign="top">
	...
	<tr>
		<td><x:display name="permission.editPermissionForm" /></td>
	</tr>
</table>
