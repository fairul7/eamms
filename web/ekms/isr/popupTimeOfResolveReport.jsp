...
<table border="0" cellpadding="2" cellspacing="0" width="100%" valign="top">
	<tr>
		...
		Time Of Resolve Report - <c:out value="${widgets['timeOfResolveFormPg.timeOfResolveForm'].statusName}"/>
		<p/>
	...
	<tr>
		...
		<x:display name="timeOfResolveFormPg.timeOfResolveForm" body="/WEB-INF/templates/default/isr/popupTimeOfResolveReportForm.jsp"/>
		</td>
	</tr>
</table>
