...
<table border="0" cellpadding="2" cellspacing="0" width="100%" valign="top">
	...
	<tr>
		<td colspan="2" class="contentBgColor"><x:display name="priorityReportTablePg.priorityReportTable" body="/WEB-INF/templates/default/isr/popupPriorityReport.jsp"/></td>
	</tr>
</table>
