...
<table border="0" cellpadding="2" cellspacing="0" width="100%" valign="top">
	<tr>
		...
		<fmt:message key="isr.label.date"/>: <fmt:formatDate value="${widgets['commonStatsFormPg.commonStatsForm'].fromDate.date}" type="date" pattern="dd-MMM-yyyy" />
		to
		<fmt:formatDate value="${widgets['commonStatsFormPg.commonStatsForm'].toDate.date}" type="date" pattern="dd-MMM-yyyy" />
		</span>
		</p>
		</td>
	...
	<tr>
		<td colspan="2">
		<x:display name="commonStatsFormPg.commonStatsForm" body="/WEB-INF/templates/default/isr/popupCommonStatsReportForm.jsp"/>
		</td>
	</tr>
</table>
