...
<c:when test="${forward.name == 'cancel'}" >
    <%
        ...
        pageContext.setAttribute("wholeId", id);
    ...
    <c:choose>
        <c:when test="${id == appointment}" >
            <c:redirect url="/ekms/calendar/editappointmentform.jsp" >
            	<c:param name="eventId" value="${pageScope.wholeId}" />
            </c:redirect>
        </c:when>
        <c:when test="${id == event}" >
            <c:redirect url="/ekms/calendar/editeventform.jsp" ></c:redirect>
        </c:when>
        <c:when test="${id == emeeting}" >
            <c:redirect url="/ekms/calendar/editemeetingform.jsp" ></c:redirect>
        </c:when>
    </c:choose>
