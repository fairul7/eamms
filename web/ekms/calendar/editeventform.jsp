...
<c:if test="${forward.name=='conflict exception'}">
    ...
    <c:redirect url="/ekms/calendar/conflicts.jsp"/>
</c:if>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1">
    <tr><td class="calendarHeader"><fmt:message key='calendar.label.editEvent'/> : <c:out value="${widgets['appointmentformpage.AppointmentForm'].title.value}"/></td></tr>
</table>
