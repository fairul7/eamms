<%@ page import="com.tms.portlet.taglibs.PortalServerUtil,
                 com.tms.hr.competency.ui.UserCompetencyAdd"%><html>
<%@ include file="/common/header.jsp" %>
<x:config>
    <page name="wormsAddUserCompetency">
        <com.tms.hr.competency.ui.UserCompetencyAdd name="form"/>
    </page>
</x:config>
...
<c:if test="${forward.name == forward_success}">
    <script>
        ...
        window.opener.location="<c:url value="/ekms/profile/profile.jsp"/>";
    </script>
</c:if>
