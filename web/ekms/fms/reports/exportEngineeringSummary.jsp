<%@ page import="java.util.*,                
                 com.tms.fms.reports.ui.EngineeringSummaryResource,    
...
<%
	...
	response.setHeader("content-disposition","attachment; filename=Engineering_Resource_Report_"+todayDate+".xls");
%>


<c:set var="widget" value="${widgets['report.engform']}"/>
<c:if test="${widget != null}">


 <%
 		EngineeringSummaryResource form = (EngineeringSummaryResource)pageContext.getAttribute("widget");	
 		pageContext.setAttribute("startDate",form.getStartDate().getDate());
 		pageContext.setAttribute("endDate",form.getEndDate().getDate());
 		
        %>
        
<%@page import="org.apache.commons.lang.ArrayUtils"%><c:set var="form" value="${widget}"/>
<table cellpadding="0" cellspacing="1" width="95%" align="left" border="1">
        		<tr>
            		<td class="tableRow">
		                ...
		                <%
		                    ...
		                    Date dateReportStart = (Date)pageContext.getAttribute("startDate");
		                    Date dateReportEnd = (Date)pageContext.getAttribute("endDate");
		                    
		                    System.out.print(">>>"+pageContext.getAttribute("startDate"));
		                    System.out.print("\n>>>"+pageContext.getAttribute("endDate"));
						...
						<table width="100%" border="1" cellspacing="1" cellpadding="0" class="borderTable">
                			<tr>
