...
<x:set name="Setup.form" property="setupType" value="<%= SetupObject.SETUP_INACTIVE_REASON %>"/>
<x:set name="Setup.table" property="setupType" value="<%= SetupObject.SETUP_INACTIVE_REASON %>"/>
