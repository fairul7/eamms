...
<c:choose>
	...
	<c:otherwise>
		<c:set var="setupId" value="${widgets['RateCard.form'].id}"/>
	</c:otherwise>
</c:choose>

<x:set name="RateCard.form" property="id" value="${setupId}"/>
<x:set name="RateCard.form" property="action" value="<%= RateCardForm.FORM_ACTION_EDIT %>"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr valign="middle">
		<td height="22" bgcolor="#EFEFEF" class="contentBgColor"><strong><fmt:message key='fms.tran.setup.editTransportCharges'/></strong>
