...
<x:config>
  <page name="fms_AssignmentListingPage">
     <!--<com.tms.fms.facility.ui.AssignmentTable name="listing" width="100%"/>-->
     <com.tms.fms.facility.ui.AssignmentListingTable name="listing" width="100%"/>
  </page>
</x:config>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="fms_AssignmentListingPage.listing"/>
