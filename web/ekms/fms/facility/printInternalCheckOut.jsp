...
<x:config>
  <page name="fms_printInternalCheckOutPage">
    <com.tms.fms.facility.ui.PrintInternalCheckOutForm name="details" width="100%"/>
  </page>
</x:config>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#FFFFFF">
        <x:display name="fms_printInternalCheckOutPage.details"/>
    </td></tr>
