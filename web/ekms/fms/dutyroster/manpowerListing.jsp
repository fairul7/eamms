...
<x:config>
  <page name="fms_manpowerListingPage">
    <com.tms.fms.facility.ui.ManpowerTable name="listing" width="100%"/>
  </page>
</x:config>
...
<c:if test="${forward.name == 'ADD'}">
  <c:redirect url="manpowerAdd.jsp"/>
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="fms_manpowerListingPage.listing"/>
