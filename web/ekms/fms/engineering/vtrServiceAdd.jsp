...
<x:config>
	<page name="fms_vtrPage">
    	<com.tms.fms.engineering.ui.VtrForm name="add" width="100%"/>
	</page>
</x:config>
<c:set var="type" value="Add"/>
<x:set name="fms_vtrPage.add" property="type" value="${type}"/>
...
<x:set name="fms_vtrPage.add" property="requestId" value="${requestId}"/>
<x:set name="fms_vtrPage.add" property="dtRequiredFrom" value="${dtRequiredFrom}" />
<x:set name="fms_vtrPage.add" property="dtRequiredTo" value="${dtRequiredTo}" />
...
<c:choose>
  ...
  <c:otherwise>
    <c:set var="serviceId" value="${widgets['fms_vtrPage.add'].serviceId}"/>
  </c:otherwise>
</c:choose>
<x:set name="fms_vtrPage.add" property="serviceId" value="${serviceId}"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        <x:display name="fms_vtrPage.add"/>
    </td></tr>
</table>

<script type="text/javascript">
var dateFrom=document.forms["fms_vtrPage.add"].elements["fms_vtrPage.add.requiredFrom"].value;
var dateTo=document.forms["fms_vtrPage.add"].elements["fms_vtrPage.add.requiredTo"].value;
var h1 = 0;
var h2 = 0;
var m1 = 0;
var m2 = 0;
...
function populateClientName(){
	var selValue = document.getElementById('fms_vtrPage.add.serviceParticulars').options[document.getElementById('fms_vtrPage.add.serviceParticulars').selectedIndex].value;
