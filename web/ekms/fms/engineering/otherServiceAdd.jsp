...
<x:config>
	<page name="fms_otherServicePage">
    	<com.tms.fms.engineering.ui.OtherServiceForm name="add" width="100%"/>
	</page>
</x:config>
<c:set var="type" value="Add"/>
<x:set name="fms_otherServicePage.add" property="type" value="${type}"/>
...
<x:set name="fms_otherServicePage.add" property="requestId" value="${requestId}"/>
<x:set name="fms_otherServicePage.add" property="dtRequiredFrom" value="${dtRequiredFrom}" />
<x:set name="fms_otherServicePage.add" property="dtRequiredTo" value="${dtRequiredTo}" />
...
<c:choose>
  ...
  <c:otherwise>
    <c:set var="serviceId" value="${widgets['fms_otherServicePage.add'].serviceId}"/>
  </c:otherwise>
</c:choose>
<x:set name="fms_otherServicePage.add" property="serviceId" value="${serviceId}"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr valign="middle">
        <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont"><fmt:message key="fms.facility.msg.otherServiceBooking"/></font></b></td>
        <td align="right" bgcolor="#003366" class="contentTitleFont">&nbsp;</td>
    </tr>
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor"><img src="<c:url value="/ekms/" />images/blank.gif" width="5" height="10"></td></tr>
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        <x:display name="fms_otherServicePage.add"/>
    </td></tr>
</table>

<script>
var dateFrom=document.forms["fms_otherServicePage.add"].elements["fms_otherServicePage.add.requiredFrom"].value;
var dateTo=document.forms["fms_otherServicePage.add"].elements["fms_otherServicePage.add.requiredTo"].value;
var h1 = 0;
var h2 = 0;
var m1 = 0;
var m2 = 0;
