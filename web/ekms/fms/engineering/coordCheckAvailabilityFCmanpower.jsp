...
<x:config>
     <page name="checkAvailabilityFCmanpower">
		<com.tms.fms.engineering.ui.CheckAvailabilityFCManpowerForm mode="coordinator" name="form" width="100%"/>
     </page>
</x:config>
...
<script language="JavaScript">
	function goToFacility(){
		window.location='coordCheckAvailability.jsp?requestId=<c:out value="${id}" />'
	}
</script>
