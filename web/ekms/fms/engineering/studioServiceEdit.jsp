...
<x:config>
  <page name="fms_studioPage">
    	<com.tms.fms.engineering.ui.StudioForm name="edit" width="100%"/>
  </page>
</x:config>
...
<c:choose>
  ...
  <c:otherwise>
    <c:set var="id" value="${widgets['fms_studioPage.edit'].id}"/>
  </c:otherwise>
</c:choose>
<x:set name="fms_studioPage.edit" property="id" value="${id}"/>
<x:set name="fms_studioPage.edit" property="type" value="${type}"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="fms_studioPage.edit"/>
