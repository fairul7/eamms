...
<x:config>
  <page name="fms_requestListingPage">
    <com.tms.fms.engineering.ui.RequestTable name="listing" width="100%"/>
  </page>
</x:config>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr valign="middle">
        <td height="22" bgcolor="#003366" class="contentTitleFont"><b><font color="#FFCF63" class="contentTitleFont"><fmt:message key="fms.request.label.myFacilityRequest"/></font></b></td>
