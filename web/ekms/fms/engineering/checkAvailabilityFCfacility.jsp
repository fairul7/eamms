...
<x:config>
     <page name="checkAvailabilityFCfacility">
		<com.tms.fms.engineering.ui.CheckAvailabilityFCFacilityForm mode="check" name="form" width="100%"/>
     </page>
</x:config>
...
<script language="JavaScript">
	function goToManpower(){
		window.location='checkAvailabilityFCmanpower.jsp?requestId=<c:out value="${id}" />'
	}
</script>
