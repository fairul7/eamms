...
<x:config>
     <page name="RequestFClate">
		<com.tms.fms.engineering.ui.RequestFCLateForm name="form" width="100%"/>
     </page>
</x:config>

<c:set var="requestId" value="${widgets['fms_requestDetailsPage.details'].requestId}"/>
<x:set name="RequestFClate.form" property="requestId" value="${requestId}"/>
...
<table width="100%" cellpadding="0" cellspacing="0" class="contentBgColor">
	<tr valign="MIDDLE">
    	<td height="22" class="contentTitleFont">
      		&nbsp;<fmt:message key='fms.request.label.requestLate'/>  
        </td>
  	...
  	<tr>
    	<td colspan="2" valign="TOP" class="contentBgColor">
			<x:display name="RequestFClate.form" ></x:display>
		</td>
  	</tr>
  	<tr>
    	<td colspan="2" valign="TOP" class="contentBgColor">
