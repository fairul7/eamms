...
<x:config>
  <page name="fms_completeAssignmentHOU">
...
<c:choose>
	<c:when test="${forward.name == 'COMPLETE'}">
		<script>
			...
			window.opener.location='todaysAssignment.jsp';		
			window.close();
		</script>
	</c:when>
...
<x:set name="fms_completeAssignmentHOU.update" property="groupId" value="${groupId}"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="fms_completeAssignmentHOU.update"/>
