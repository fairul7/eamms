...
<x:config>
  <page name="eamms_addFeedLog">
    <com.tms.fms.eamms.ui.FeedsLogForm name="form" width="100%"/>
  </page>
</x:config>
<x:set name="eamms_addFeedLog.form" property="mode" value="<%=FeedsLogForm.ADD%>"/>

<c:if test="${param.reset == '1'}" >
    <x:set name="eamms_addFeedLog.form" property="runInit" value="<%=true%>"/>
</c:if>

<c:if test="${forward.name=='continue' || forward.name=='back'}" >
    <script>
        document.location='dailyFeedsLogAdd.jsp';
    </script>
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr valign="middle">
        <td height="22" bgcolor="#003366" class="contentTitleFont">
            <b><font color="#FFCF63" class="contentTitleFont">
                <fmt:message key="eamms.feed.log.msg.newLog"/>
            </font></b>
        </td>
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="eamms_addFeedLog.form"/>
