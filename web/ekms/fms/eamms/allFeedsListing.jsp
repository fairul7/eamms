...
<x:permission permission="com.tms.fms.permission.feed.allFeedsListing" module="com.tms.fms.eamms.model.EammsFeedsModule" var="hvPermission"/>
<c:if test="${!hvPermission}">
    <script>
        document.location="allFeedsListingOwn.jsp";
    </script>
</c:if>

<x:config>
  <page name="eamms_allFeeds">
    <com.tms.fms.eamms.ui.DailyFeedsListingWithExport name="listing" width="100%"/>
  </page>
</x:config>

<x:set name="eamms_allFeeds.listing" property="mode" value="<%=DailyFeedsListingWithExport.VIEW_ALL%>"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr valign="middle">
        <td height="22" bgcolor="#003366" class="contentTitleFont">
            <b><font color="#FFCF63" class="contentTitleFont">
                <fmt:message key="eamms.feed.msg.allFeedsListing"/>
            </font></b>
        </td>
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="eamms_allFeeds.listing"/>
