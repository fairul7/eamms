...
<x:permission permission="com.tms.fms.permission.feed.feedsHistory" module="com.tms.fms.eamms.model.EammsFeedsModule" var="hvPermission"/>
...
<x:config>
  <page name="eamms_feedHistory">
    <com.tms.fms.eamms.ui.DailyFeedsListingWithExport name="listing" width="100%"/>
  </page>
</x:config>

<x:set name="eamms_feedHistory.listing" property="mode" value="<%=DailyFeedsListingWithExport.VIEW_HISTORY%>"/>

<c:if test="${!empty param.requestId}">
    <script> 
        window.location='feedRequisitionForm_viewOnly.jsp?requestId=<c:out value="${param.requestId}"/>&history=1'
    </script>
</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr valign="middle">
        <td height="22" bgcolor="#003366" class="contentTitleFont">
            <b><font color="#FFCF63" class="contentTitleFont">
                <fmt:message key="eamms.feed.msg.feedsHistory"/>
            </font></b>
        </td>
    ...
    <tr><td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
        ...
        <x:display name="eamms_feedHistory.listing"/>
