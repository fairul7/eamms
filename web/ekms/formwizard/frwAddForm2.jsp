...
<!-- Declare Widgets -->
<x:config>
    <page name="ekmsAddFormPage2">
        	<com.tms.collab.formwizard.ui.AddForm2 name="ekmsAddForm2"/>
    </page>
</x:config>
...
if (wm != null){
	AddForm form = (AddForm)wm.getWidget("ekmsAddFormPage2.ekmsAddForm2");
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" valign="TOP" bgcolor="#EFEFEF" class="contentBgColor">
			     <x:display name="ekmsAddFormPage2.ekmsAddForm2" ></x:display>
    </td>
  </tr>
  <tr>
