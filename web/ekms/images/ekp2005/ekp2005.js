...
function toggleHeaderTopMenu()
{
	if(document.getElementById("ekmsTopMenu").style.visibility == "hidden" || document.getElementById("ekmsTopMenu").style.visibility == "")
	{
		...
		document.getElementById("ekmsTopMenu").style.zIndex="100";
		if(isIE)
		{
...
function initLeftMenu()
{
    ...
    if((document.getElementById("leftMenuShortcuts").style.display == "none")&&(document.getElementById("leftMenuSearch").style.display == "none")&&(document.getElementById("leftMenuHelp").style.display == "none"))
        toggleLeftTabs("leftMenuShortcuts", "leftMenuSearch", "leftMenuHelp", "leftMenuMessenger");
    //Toggling Images
    ...
    if(document.getElementById("leftMenuMessenger").style.display == "block")
        document.getElementById("leftMenuMessengerImage").src = "/ekms/images/ekp2005/tab_mesg_on.gif";
    else
        document.getElementById("leftMenuMessengerImage").src = "/ekms/images/ekp2005/tab_mesg_off.gif";
    if(document.getElementById("ekmsLeftMenu").style.display == "block")
...
function toggleLeftTabs(show, hide1, hide2, hide3)
{
	...
	document.getElementById(hide3 + "Image").src="/ekms/images/ekp2005/" + hide3 + "_off.gif";
	treeSave(show);
	treeSave(hide1);
	treeSave(hide2);
	treeSave(hide3);
