...
<x:config>
    <page name="quote_jsp_contactView">
     	<com.tms.crm.sales.ui.ContactForm name="form1" type="View" width="100%" />
    </page>
</x:config>


<x:set name="quote_jsp_contactView.form1" property="contactID" value="${contactID}" />


<x:display name="quote_jsp_contactView.form1"></x:display>
