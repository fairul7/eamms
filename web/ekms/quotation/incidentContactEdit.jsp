...
--%>
<x:config>
    <page name="quote_incidentContactEdit">
...
<c:if test="${forward.name =='cancel'}" >
    <c:redirect url="incidentContactView.jsp?contactID=${widgets['quote_incidentContactEdit.form1'].contactID}" />
</c:if>
...
<c:choose>
	...
	<c:otherwise>
		<c:set var="contactID" value="${widgets['quote_incidentContactEdit.form1'].contactID}" />
	</c:otherwise>
</c:choose>
<x:set name="quote_incidentContactEdit.form1" property="contactID" value="${contactID}" />
<c:choose>
	...
	<x:display name="quote_incidentContactEdit.form1"></x:display>
