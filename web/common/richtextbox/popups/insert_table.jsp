...
<head><title><fmt:message key='richTextBox.insertTable'/></title><head>
<style>
...
<table border=0 cellspacing=0 cellpadding=0 style="margin: 0 0 8 0">
 <tr>
  <td><fmt:message key='richTextBox.rows'/>: &nbsp;</td>
  <td><input type="text" name="rows" value="4"  style="width: 50px" maxlength=4></td>
 </tr>
 <tr>
  <td><fmt:message key='richTextBox.cols'/>:</td>
  <td><input type="text" name="cols" value="3"  style="width: 50px" maxlength=4></td>
  <td width=10>&nbsp;</td>
  <td><fmt:message key='richTextBox.width'/>: &nbsp;</td>
  <td>
   <input type="text" name="width" value="100" style="width: 50px" maxlength=4>
   <select name="widthExt">
    <option value=""><fmt:message key='richTextBox.pixels'/></option>
    <option value="%" selected><fmt:message key='richTextBox.percent'/></option>
   </select>
  </td>
 </tr>
</table>
...
<LEGEND><fmt:message key='richTextBox.layout'/></LEGEND>

<table border=0 cellspacing=6 cellpadding=0>
 <tr>
  <td height=21><fmt:message key='richTextBox.alignment'/>:</td>
  <td>
   ...
   <option value="baseline"><fmt:message key='richTextBox.baseline'/></option>
 ...
 <tr>
  <td><nobr><fmt:message key='richTextBox.borderThickness'/>:</nobr></td>
...
<FIELDSET style="width: 1%; text-align: center">
<LEGEND><fmt:message key='richTextBox.spacing'/></LEGEND>

<table border=0 cellspacing=6 cellpadding=0>
 <tr>
  <td><nobr><fmt:message key='richTextBox.cellSpacing'/>:</nobr></td>
  <td><input type="text" name="cellspacing" value="1" style="width: 50px" maxlength=4></td>
 </tr>
 <tr>
  <td><nobr><fmt:message key='richTextBox.cellPadding'/>:</nobr></td>
...
<div style="left: 340px; top: 16px; position: absolute">
 <BUTTON style="width: 7em; height: 2.2em; margin: 0 0 3 0" type=submit onclick="btnOKClick()"><fmt:message key='richTextBox.ok'/></BUTTON><br>
 <BUTTON style="width: 7em; height: 2.2em; " type=reset onClick="window.close();"><fmt:message key='richTextBox.cancel'/></BUTTON>
</div>
