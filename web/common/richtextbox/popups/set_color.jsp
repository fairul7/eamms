...
<html STYLE="width: 238px; height: 196px"><head><title><fmt:message key='richTextBox.selectColor'/></title>
...
<table border=0 cellspacing=0 cellpadding=4 width=100%>
 <tr>
  ...
  <td bgcolor="buttonface" width=100%><!--<img border="0" src="../images/ed_transparentcolor.gif" onMouseOver=View('') onClick=Set('')>-->&nbsp;</td>
 </tr>
</table>
