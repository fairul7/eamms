...
<html>
<head><title><fmt:message key='richTextBox.fullscreenEditor'/></title>
...
function init() {
  ...
  config.btnList["popupeditor"] = ['popupeditor', '<fmt:message key='richTextBox.minimizeEditor'/>',  'update_parent(); window.close();', 'fullscreen_minimize.gif'];

  // set htmlmode button to refer to THIS editor
  config.btnList["htmlmode"]    = ['HtmlMode',    '<fmt:message key='richTextBox.viewHTMLSource'/>', 'editor_setmode(\'editor\')',  'ed_html.gif'];
