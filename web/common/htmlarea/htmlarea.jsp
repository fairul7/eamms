...
// load some scripts
(function() {
	var scripts = HTMLArea._scripts = [ _editor_url + "htmlarea.jsp",
...
HTMLArea.prototype._createLink = function(link) {
    ...
    // MODIFIED: modified to allow customized popup URL
	this._popupDialog("<c:choose><c:when test="${!empty param.linkUrl}"><c:out value="${param.linkUrl}"/></c:when><c:otherwise>link.html</c:otherwise></c:choose>", function(param) {
		if (!param)
			return false;
		var a = link;
		if (!a) {
...
HTMLArea.prototype._insertImage = function(image) {
    ...
    // MODIFIED: modified to allow customized popup URL
	this._popupDialog("<c:choose><c:when test="${!empty param.imageUrl}"><c:out value="${param.imageUrl}"/></c:when><c:otherwise>insert_image.html</c:otherwise></c:choose>", function(param) {
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		if (HTMLArea.is_ie) {
			...
			{
                // MODIFIED: modified to support JSP popup URL
