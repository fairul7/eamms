...
HTMLArea.Config = function()
{
  ...
  this.baseHref = "<%= request.getScheme() + "://" + request.getServerName() + (request.getServerPort() != 80 ? ":" + request.getServerPort() : "") %>";;
...
//    ["separator","killword","clearfonts","removeformat","toggleborders","splitblock","lefttoright", "righttoleft"],
  ...
  this.URIs =
  {
   ...
   "link": "<c:choose><c:when test='${!empty param.linkUrl}'><c:out value='${param.linkUrl}'/></c:when><c:otherwise>link.html</c:otherwise></c:choose>",
   "insert_image": "<c:choose><c:when test='${!empty param.imageUrl}'><c:out value='${param.imageUrl}'/></c:when><c:otherwise>insert_image.html</c:otherwise></c:choose>",
...
HTMLArea.prototype._createLink = function(link)
{
  ...
  this._popupDialog(
    ...
    function(param)
    {
      ...
      if (param.f_target != null)
      	a.target = param.f_target.trim();
      if (param.f_title != null)
...
"p h1 h2 h3 h4 h5 h6 quote pre table thead object script" +
