...
%>
	...
	this._monthNames = [
		"<fmt:message key='general.label.january'/>","<fmt:message key='general.label.february'/>","<fmt:message key='general.label.march'/>",
        "<fmt:message key='general.label.april'/>","<fmt:message key='general.label.may'/>","<fmt:message key='general.label.june'/>",
        "<fmt:message key='general.label.july'/>","<fmt:message key='general.label.august'/>","<fmt:message key='general.label.september'/>",
        "<fmt:message key='general.label.october'/>","<fmt:message key='general.label.november'/>","<fmt:message key='general.label.december'/>"
	];

	this._shortMonthNames = [
		"<fmt:message key='general.label.jan'/>", "<fmt:message key='general.label.feb'/>",
        "<fmt:message key='general.label.mar'/>", "<fmt:message key='general.label.apr'/>",
        "<fmt:message key='general.label.may'/>", "<fmt:message key='general.label.jun'/>",
		"<fmt:message key='general.label.jul'/>", "<fmt:message key='general.label.aug'/>",
        "<fmt:message key='general.label.sep'/>", "<fmt:message key='general.label.oct'/>",
        "<fmt:message key='general.label.nov'/>", "<fmt:message key='general.label.dec'/>"
	];

	// Week days start with Sunday=0, ... Saturday=6
	this._weekDayNames = [
		"<fmt:message key='general.label.sunday'/>", "<fmt:message key='general.label.monday'/>",
        "<fmt:message key='general.label.tuesday'/>", "<fmt:message key='general.label.wednesday'/>",
        "<fmt:message key='general.label.thursday'/>", "<fmt:message key='general.label.friday'/>",
        "<fmt:message key='general.label.saturday'/>"
	];

	this._shortWeekDayNames =
		[
        "<fmt:message key='general.label.sun'/>", "<fmt:message key='general.label.mon'/>",
        "<fmt:message key='general.label.tue'/>", "<fmt:message key='general.label.wed'/>",
        "<fmt:message key='general.label.thu'/>", "<fmt:message key='general.label.fri'/>",
        "<fmt:message key='general.label.sat'/>"
	];
...
Calendar.prototype.create = function() {
	...
	this._previousMonth.className = "button"
	...
	this._nextMonth.className = "button";
	...
	if (this._includeWeek) {
		...
		text = document.createTextNode("<fmt:message key='general.label.week'/>");
		td.appendChild(text);
	...
	this._todayButton.className = "button"
	var today = new Date();
	...
	this._clearButton.className = "button"
	var today = new Date();
	buttonText = "<fmt:message key='general.label.clear'/>";
...
Calendar.prototype.nextMonth = function () {
    var month = this._currentDate.getMonth()+1;
	var d = new Date(this._currentDate);
	d.setMonth(month);
	if (d.getYear() == this._currentDate.getYear() && d.getMonth() > month) {
	    d.setMonth(month);
	}
	this.setCurrentDate(d);
}
...
Calendar.prototype.prevMonth = function () {
	...
	var d = new Date(this._currentDate);
	d.setMonth(month);
	if (d.getYear() == this._currentDate.getYear() && d.getMonth() <= (month+1)) {
	    d.setMonth(month);
	}
	this.setCurrentDate(d);
}
...
Calendar.prototype.formatDate = function() {
    ...
    var sect;
    for (sect in bits) {
      //when a form contains RichTextBox and datePopupField, datePopupField will not work,
      //the following if condition will fix the problem
      if(sect != 'contains' && sect != 'append' && sect != 'indexOf')
